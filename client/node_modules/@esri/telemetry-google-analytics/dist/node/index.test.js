...
describe('Google Analytics', () => {
    ...
    describe('constructor', () => {
        it('should call the constructor with options', () => {
            const googleAnalytics = new _1.GoogleAnalytics({
    ...
    describe('init', () => {
        it('should call injectConfig', async () => {
            const googleAnalytics = new _1.GoogleAnalytics({ measurementIds: ['G-1234567890'] });
    ...
    describe('injectConfig', () => {
        ...
        it('should add in custom metrics and dimensions accordingly', async () => {
            jest.spyOn(_1.GoogleAnalytics.prototype, 'createDimensionsAndMetricsCustomMap').mockImplementation(() => { return { dimension1: 'details', metric3: 'duration' }; });
            const googleAnalytics = new _1.GoogleAnalytics({ measurementIds: ['G-1234567890'], dimensions: { details: 1 }, metrics: { duration: 3 } });
            expect(window.dataLayer).toEqual(undefined);
            await googleAnalytics.init();
            const dataLayer = window.dataLayer;
            expect(dataLayer.length).toBe(2);
    ...
    describe('createDimensionsAndMetricsCustomMap', () => {
        ...
        it('creates dimensions and custom map with dimensions but no custom metrics', () => {
            const googleAnalytics = new _1.GoogleAnalytics({ measurementIds: ['G-1234567890'], dimensions: { type: 4 } });
        ...
        it('creates dimensions and custom map with metrics but no custom dimensions', () => {
            const googleAnalytics = new _1.GoogleAnalytics({ measurementIds: ['G-1234567890'], metrics: { duration: 3 } });
        ...
        it('creates dimensions and custom map with custom metrics and custom dimensions', () => {
            const googleAnalytics = new _1.GoogleAnalytics({ measurementIds: ['G-1234567890'], dimensions: { type: 4, search: 9 }, metrics: { duration: 3, size: 4 } });
