...
const should_disable_tracking_1 = require("./should-disable-tracking");
...
class Telemetry {
    ...
    getWorkflow(name) {
        const workflow = storage_1.storage.get(`TELEMETRY-WORKFLOW:${name}`);
    ...
    saveWorkflow(workflow) {
        storage_1.storage.set(`TELEMETRY-WORKFLOW:${workflow.name}`, workflow);
    }
    deleteWorkflow(workflow) {
        storage_1.storage.delete(`TELEMETRY-WORKFLOW:${workflow.name}`);
    }
    logWorkflow(options = {}) {
        /*
        const workflow = {
