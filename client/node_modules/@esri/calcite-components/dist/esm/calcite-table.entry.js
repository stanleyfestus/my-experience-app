...
import { n as numberStringFormatter, c as connectLocalized, d as disconnectLocalized } from './locale-60f8ca58.js';
import { g as getUserAgentString } from './browser-618ac057.js';
...
const Table = class {
    ...
    render() {
        return (h(Host, { key: '8e6d0b48e0ffa640e5d0e052092bccf1b4b7fafe' }, h("div", { key: 'ce5932eda4dbec9b60ee5a7aad523e5d47178888', class: CSS.container }, this.selectionMode !== "none" &&
            this.selectionDisplay !== "none" &&
            this.renderSelectionArea(), h("div", { key: '37fb918ba3079352db0ca83c253f648c327cc3d8', class: {
                [CSS.bordered]: this.bordered,
                [CSS.striped]: this.striped || this.zebra,
                [CSS.tableContainer]: true,
            } }, h("table", { key: '908c1e7ce7768c1c9f3146b83546ae639a86bac8', "aria-colcount": this.colCount, "aria-multiselectable": this.selectionMode === "multiple", "aria-rowcount": this.allRows?.length, class: { [CSS.tableFixed]: this.layout === "fixed" }, role: this.interactionMode === "interactive" ? "grid" : "table" }, h("caption", { key: '9ab15b8e9badee9b38925e563e5c607a13ccf664', class: CSS.assistiveText }, this.caption), this.renderTHead(), this.renderTBody(), this.renderTFoot())), this.pageSize > 0 && this.renderPaginationArea())));
    }
