...
import { s as submitForm, c as connectForm, d as disconnectForm, H as HiddenFormInputSlot } from './form-8ec29459.js';
import { u as updateHostInteraction, I as InteractiveContainer } from './interactive-1a42577a.js';
import { n as numberKeys } from './key-3ee05994.js';
...
import { n as numberStringFormatter, f as getDateTimeFormat, i as isValidNumber, e as getSupportedNumberingSystem, g as getSupportedLocale, c as connectLocalized, d as disconnectLocalized } from './locale-60f8ca58.js';
import { a as activateFocusTrap, d as deactivateFocusTrap, c as connectFocusTrap } from './focusTrapComponent-7cfd1d69.js';
import { d as decimalPlaces, g as getDecimals } from './math-682795d0.js';
...
import { f as focusFirstTabbable, t as toAriaBoolean } from './dom-b6dedd88.js';
import { s as syncHiddenFormInput } from './input-871f5b21.js';
...
const supportedDayjsLocaleToLocaleConfigImport = new Map([
    ["ar", () => import('./ar-2df9d459.js')],
    ["bg", () => import('./bg-d781d571.js')],
    ["bs", () => import('./bs-eaf434b8.js')],
    ["ca", () => import('./ca-61a444ea.js')],
    ["cs", () => import('./cs-09566375.js')],
    ["da", () => import('./da-62f4c611.js')],
    ["de", () => import('./de-987b9224.js')],
    ["de-at", () => import('./de-at-88f22f2f.js')],
    ["de-ch", () => import('./de-ch-4b5b5e77.js')],
    ["el", () => import('./el-a12e4a3b.js')],
    ["en", () => Promise.resolve().then(function () { return en$1; })],
    ["en-au", () => import('./en-au-800eba81.js')],
    ["en-ca", () => import('./en-ca-32846c7d.js')],
    ["en-gb", () => import('./en-gb-6ac6a7b1.js')],
    ["es", () => import('./es-bd653a11.js')],
    ["es-mx", () => import('./es-mx-74feefd3.js')],
    ["et", () => import('./et-6788de92.js')],
    ["fi", () => import('./fi-85ee83c7.js')],
    ["fr", () => import('./fr-a7694ecb.js')],
    ["fr-ch", () => import('./fr-ch-3c7ee7e7.js')],
    ["he", () => import('./he-035eada6.js')],
    ["hi", () => import('./hi-277b3bf8.js')],
    ["hr", () => import('./hr-b38cf6b0.js')],
    ["hu", () => import('./hu-eafd33fa.js')],
    ["id", () => import('./id-93c1c6dc.js')],
    ["it", () => import('./it-798f8676.js')],
    ["it-ch", () => import('./it-ch-fd04be59.js')],
    ["ja", () => import('./ja-d01787cb.js')],
    ["ko", () => import('./ko-c7252f1d.js')],
    ["lt", () => import('./lt-cb19b211.js')],
    ["lv", () => import('./lv-257e61b3.js')],
    ["mk", () => import('./mk-f4da11ec.js')],
    ["nl", () => import('./nl-127ea5c5.js')],
    ["nb", () => import('./nb-bb7185b5.js')],
    ["pl", () => import('./pl-f54c6e1c.js')],
    ["pt", () => import('./pt-b053f15a.js')],
    ["pt-br", () => import('./pt-br-fe7942bf.js')],
    ["ro", () => import('./ro-309a5d9e.js')],
    ["ru", () => import('./ru-6235dc2b.js')],
    ["sk", () => import('./sk-55221022.js')],
    ["sl", () => import('./sl-4bb98765.js')],
    ["sr", () => import('./sr-7095d964.js')],
    ["sv", () => import('./sv-661c26eb.js')],
    ["th", () => import('./th-635f0333.js')],
    ["tr", () => import('./tr-aa830cb8.js')],
    ["uk", () => import('./uk-61308ab4.js')],
    ["vi", () => import('./vi-1bd7d7b9.js')],
    ["zh-cn", () => import('./zh-cn-5845bb5b.js')],
    ["zh-hk", () => import('./zh-hk-84423a19.js')],
    ["zh-tw", () => import('./zh-tw-f5ede1cf.js')],
]);
...
const InputTimePicker = class {
    ...
    renderToggleIcon(open) {
        return (h("span", { class: CSS$1.toggleIcon, slot: "action" }, h("calcite-icon", { icon: open ? "chevron-up" : "chevron-down", scale: getIconScale(this.scale) })));
    }
...
const TimePicker = class {
    ...
    render() {
        ...
        return (h("div", { key: 'e15ff4d20ae40919921b991d99c8c76625a73cfc', class: {
                [CSS.timePicker]: true,
                [CSS.showMeridiem]: showMeridiem,
                [CSS.showSecond]: this.showSecond,
                [CSS[`scale-${this.scale}`]]: true,
            }, dir: "ltr" }, h("div", { key: 'd4bfad89ac334afbb31bb4fc8e8fe386142f6d4b', class: CSS.column, role: "group" }, h("span", { key: 'ba564179d2ca507bbb659b9b38de09625afe35f2', "aria-label": this.messages.hourUp, class: {
                [CSS.button]: true,
                [CSS.buttonHourUp]: true,
                [CSS.buttonTopLeft]: true,
            }, onClick: this.hourUpClickHandler, role: "button" }, h("calcite-icon", { key: '5aa45f9254a0394584e214fc5173d2607a706832', icon: "chevron-up", scale: iconScale })), h("span", { key: '79e888572eabf36cefd24f15e06c4e36f0550b63', "aria-label": this.messages.hour, "aria-valuemax": "23", "aria-valuemin": "1", "aria-valuenow": (hourIsNumber && parseInt(this.hour)) || "0", "aria-valuetext": this.hour, class: {
                [CSS.input]: true,
                [CSS.hour]: true,
                [CSS.inputFocus]: this.activeEl && this.activeEl === this.hourEl,
            }, onClick: this.inputClickHandler, onFocus: this.focusHandler, onKeyDown: this.hourKeyDownHandler, ref: this.setHourEl, role: "spinbutton", tabIndex: 0 }, this.localizedHour || "--"), h("span", { key: '6964ac9f00917c3da0b9161f14cfdc85c38dfef4', "aria-label": this.messages.hourDown, class: {
                [CSS.button]: true,
                [CSS.buttonHourDown]: true,
                [CSS.buttonBottomLeft]: true,
            }, onClick: this.hourDownClickHandler, role: "button" }, h("calcite-icon", { key: 'c3985301caa70272059aecfb18a29a0b7ba7fb83', icon: "chevron-down", scale: iconScale }))), h("span", { key: 'a9aa1571b4a9266276c7f684053b665397164582', class: CSS.delimiter }, this.localizedHourSuffix), h("div", { key: '0b1f353766357c699e1815af3105a5c0bc1d1a32', class: CSS.column, role: "group" }, h("span", { key: 'ed36c1fe986b96db3f8f50c6b518c78d5a1239d6', "aria-label": this.messages.minuteUp, class: {
                [CSS.button]: true,
                [CSS.buttonMinuteUp]: true,
            }, onClick: this.minuteUpClickHandler, role: "button" }, h("calcite-icon", { key: '7da952d6ef1a05f63367b5d67dd7625f0efc12f8', icon: "chevron-up", scale: iconScale })), h("span", { key: '90bc5c9b7d12a8a7769a42e4a4dc86053da03b22', "aria-label": this.messages.minute, "aria-valuemax": "12", "aria-valuemin": "1", "aria-valuenow": (minuteIsNumber && parseInt(this.minute)) || "0", "aria-valuetext": this.minute, class: {
                [CSS.input]: true,
                [CSS.minute]: true,
                [CSS.inputFocus]: this.activeEl && this.activeEl === this.minuteEl,
            }, onClick: this.inputClickHandler, onFocus: this.focusHandler, onKeyDown: this.minuteKeyDownHandler, ref: this.setMinuteEl, role: "spinbutton", tabIndex: 0 }, this.localizedMinute || "--"), h("span", { key: '9ebd5b4a961b9b20758bab5a58d8778c6795db40', "aria-label": this.messages.minuteDown, class: {
                [CSS.button]: true,
                [CSS.buttonMinuteDown]: true,
            }, onClick: this.minuteDownClickHandler, role: "button" }, h("calcite-icon", { key: '2845804742fae9b51db039666ea693c1486d19bf', icon: "chevron-down", scale: iconScale }))), this.showSecond && h("span", { key: '0816f11d5eeb5478a6c1c9e0872f56ad4a1ecaa2', class: CSS.delimiter }, this.localizedMinuteSuffix), this.showSecond && (h("div", { key: '3b83633e26c0e024cb5084499f88edc7d72f79fc', class: CSS.column, role: "group" }, h("span", { key: '90a351d935269aa847aee19d0e91cbbb0b66d3df', "aria-label": this.messages.secondUp, class: {
                [CSS.button]: true,
                [CSS.buttonSecondUp]: true,
            }, onClick: this.secondUpClickHandler, role: "button" }, h("calcite-icon", { key: '56ec5929764834986e91054432a1ec1c746f4a45', icon: "chevron-up", scale: iconScale })), h("span", { key: 'c44f0a291d49a94141a1eaf03b9baea12365e417', "aria-label": this.messages.second, "aria-valuemax": "59", "aria-valuemin": "0", "aria-valuenow": (secondIsNumber && parseInt(this.second)) || "0", "aria-valuetext": this.second, class: {
                [CSS.input]: true,
                [CSS.second]: true,
                [CSS.inputFocus]: this.activeEl && this.activeEl === this.secondEl,
            }, onClick: this.inputClickHandler, onFocus: this.focusHandler, onKeyDown: this.secondKeyDownHandler, ref: this.setSecondEl, role: "spinbutton", tabIndex: 0 }, this.localizedSecond || "--"), h("span", { key: '4009df6e3dc774e30cbd77fc01802bc8be2f8ddf', "aria-label": this.messages.secondDown, class: {
                [CSS.button]: true,
                [CSS.buttonSecondDown]: true,
            }, onClick: this.secondDownClickHandler, role: "button" }, h("calcite-icon", { key: '2140cd873a3f10c72b7314da6c6d913b8345c778', icon: "chevron-down", scale: iconScale })))), this.showFractionalSecond && (h("span", { key: '99be37a3a562a8a217c690612d757d2a463b98fe', class: CSS.delimiter }, this.localizedDecimalSeparator)), this.showFractionalSecond && (h("div", { key: '7b1095f7972da474f96a3190097eeaf282726743', class: CSS.column, role: "group" }, h("span", { key: 'c66e94a7309934bcfe86f8d73170101937bcbbdd', "aria-label": this.messages.fractionalSecondUp, class: {
                [CSS.button]: true,
                [CSS.buttonFractionalSecondUp]: true,
            }, onClick: this.fractionalSecondUpClickHandler, role: "button" }, h("calcite-icon", { key: '45fa888598fda5d21ab6a5e2f8561314c04cfba8', icon: "chevron-up", scale: iconScale })), h("span", { key: '61d5ae14f3b1a1984d07437e57ca6e60ba64f27b', "aria-label": this.messages.fractionalSecond, "aria-valuemax": "999", "aria-valuemin": "1", "aria-valuenow": (fractionalSecondIsNumber && parseInt(this.fractionalSecond)) || "0", "aria-valuetext": this.localizedFractionalSecond, class: {
                [CSS.input]: true,
                [CSS.fractionalSecond]: true,
                [CSS.inputFocus]: this.activeEl && this.activeEl === this.fractionalSecondEl,
            }, onClick: this.inputClickHandler, onFocus: this.focusHandler, onKeyDown: this.fractionalSecondKeyDownHandler, ref: this.setFractionalSecondEl, role: "spinbutton", tabIndex: 0 }, this.localizedFractionalSecond || "--"), h("span", { key: '35d0b37c0113289a9a060ae236f9ed88597707a7', "aria-label": this.messages.fractionalSecondDown, class: {
                [CSS.button]: true,
                [CSS.buttonFractionalSecondDown]: true,
            }, onClick: this.fractionalSecondDownClickHandler, role: "button" }, h("calcite-icon", { key: '0dfd40ceff6d507cbd3495c5f5f4104b98d2ba99', icon: "chevron-down", scale: iconScale })))), this.localizedSecondSuffix && (h("span", { key: '4cee863e88b4eac2a1da4ea48cac56777025a36c', class: CSS.delimiter }, this.localizedSecondSuffix)), showMeridiem && (h("div", { key: '7cfcd524e6742691774e49e2c6ad053865f11256', class: {
                [CSS.column]: true,
                [CSS.meridiemStart]: this.meridiemOrder === 0,
            }, role: "group" }, h("span", { key: '640bcd84761d7dec7783092a53c79f5a49795014', "aria-label": this.messages.meridiemUp, class: {
                [CSS.button]: true,
                [CSS.buttonMeridiemUp]: true,
                [CSS.buttonTopRight]: true,
            }, onClick: this.meridiemUpClickHandler, role: "button" }, h("calcite-icon", { key: '134662da0e72d17cbd6d6d83657c6f37b8de9520', icon: "chevron-up", scale: iconScale })), h("span", { key: '8097bcea625e4d272c86ae1598e471e6d55e98af', "aria-label": this.messages.meridiem, "aria-valuemax": "2", "aria-valuemin": "1", "aria-valuenow": (this.meridiem === "PM" && "2") || "1", "aria-valuetext": this.meridiem, class: {
                [CSS.input]: true,
                [CSS.meridiem]: true,
                [CSS.inputFocus]: this.activeEl && this.activeEl === this.meridiemEl,
            }, onClick: this.inputClickHandler, onFocus: this.focusHandler, onKeyDown: this.meridiemKeyDownHandler, ref: this.setMeridiemEl, role: "spinbutton", tabIndex: 0 }, this.localizedMeridiem || "--"), h("span", { key: '42a40925539e83e3ab8aeae295fbbad21795e5bc', "aria-label": this.messages.meridiemDown, class: {
                [CSS.button]: true,
                [CSS.buttonMeridiemDown]: true,
                [CSS.buttonBottomRight]: true,
            }, onClick: this.meridiemDownClickHandler, role: "button" }, h("calcite-icon", { key: '36364532badec14bcc07124127156ab1561539d4', icon: "chevron-down", scale: iconScale }))))));
    }
    static get delegatesFocus() { return true; }
    static get assetsDirs() { return ["assets"]; }
    get el() { return getElement(this); }
...
//# sourceMappingURL=calcite-input-time-picker.calcite-time-picker-c0364dc5.js.map