...
import { u as isPrimaryPointerButton, h as setRequestedIcon, e as getSlotted, g as getElementDir, t as toAriaBoolean } from './dom-b6dedd88.js';
import { s as submitForm, c as connectForm, i as internalHiddenInputInputEvent, d as disconnectForm, H as HiddenFormInputSlot } from './form-8ec29459.js';
...
import { n as numberStringFormatter, i as isValidNumber, p as parseNumberString, s as sanitizeNumberString, a as addLocalizedTrailingDecimalZeros, c as connectLocalized, d as disconnectLocalized, B as BigDecimal } from './locale-60f8ca58.js';
...
const InputNumber = class {
    ...
    render() {
        ...
        const loader = (h("div", { key: 'cc2f276e80dee457d8a8f38e06d18967647e4591', class: CSS.loader }, h("calcite-progress", { key: '2764fc118ec3063a7e76e0738050fa7b3872018a', label: this.messages.loading, type: "indeterminate" })));
        const inputClearButton = (h("button", { key: '6bb6db58c8c20594f88c60f2d717ad9b4dfb9fe0', "aria-label": this.messages.clear, class: CSS.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputValue, tabIndex: -1, type: "button" }, h("calcite-icon", { key: '1746fe8d0a79b4516beb7574ba6b74b6a5070d81', icon: "x", scale: getIconScale(this.scale) })));
        const iconEl = (h("calcite-icon", { key: '4d57c3fedac7bedd8f9397c4b276866ee5b7237f', class: CSS.inputIcon, flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: getIconScale(this.scale) }));
        const isHorizontalNumberButton = this.numberButtonType === "horizontal";
        const numberButtonsHorizontalUp = (h("button", { key: 'c0e52d338c61d3d6f6349975751f6af707325db3', "aria-hidden": "true", class: {
                [CSS.numberButtonItem]: true,
                [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
            }, "data-adjustment": "up", disabled: this.disabled || this.readOnly, onPointerDown: this.nudgeButtonPointerDownHandler, onPointerOut: this.nudgeButtonPointerOutHandler, onPointerUp: this.nudgeButtonPointerUpHandler, tabIndex: -1, type: "button" }, h("calcite-icon", { key: '28697a2ed4b3581c5d190c86ef3d7ab1d70823f8', icon: "chevron-up", scale: getIconScale(this.scale) })));
        const numberButtonsHorizontalDown = (h("button", { key: '11f9db5af2916069d412089875d53fdea0b453c0', "aria-hidden": "true", class: {
                [CSS.numberButtonItem]: true,
                [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
            }, "data-adjustment": "down", disabled: this.disabled || this.readOnly, onPointerDown: this.nudgeButtonPointerDownHandler, onPointerOut: this.nudgeButtonPointerOutHandler, onPointerUp: this.nudgeButtonPointerUpHandler, tabIndex: -1, type: "button" }, h("calcite-icon", { key: '1614213fecd0d957cda096df5ddf220bacc49dca', icon: "chevron-down", scale: getIconScale(this.scale) })));
        const numberButtonsVertical = (h("div", { key: 'e8822b7270ea89e13ebf3703b6f271be512c6a9b', class: CSS.numberButtonWrapper }, numberButtonsHorizontalUp, numberButtonsHorizontalDown));
        const prefixText = h("div", { key: '333318e5c2f5fbd0d307255c7a0a4eebde29b5c8', class: CSS.prefix }, this.prefixText);
        const suffixText = h("div", { key: '4812a571237e8016e9d173036e663e91ef7df638', class: CSS.suffix }, this.suffixText);
        ...
        return (h(Host, { key: 'a765b9d4616c91517c512bf08511e7dd979ba8cc', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { key: 'b9ea4743c23e8dc2773cfb600b0e345797c3558d', disabled: this.disabled }, h("div", { key: '17dfcce5d569e546184d908cc595914d5aefe132', class: { [CSS.inputWrapper]: true, [CSS_UTILITY.rtl]: dir === "rtl" }, ref: (el) => (this.inputWrapperEl = el) }, this.numberButtonType === "horizontal" && !this.readOnly
            ? numberButtonsHorizontalDown
            : null, this.prefixText ? prefixText : null, h("div", { key: 'db2a55ec06a2418761f7a64c06b88680156870c3', class: CSS.wrapper }, childEl, this.isClearable ? inputClearButton : null, this.requestedIcon ? iconEl : null, this.loading ? loader : null), h("div", { key: '26fa02f076266dd8e4e9441d17b708994bac580d', class: CSS.actionWrapper, ref: (el) => (this.actionWrapperEl = el) }, h("slot", { key: 'cf216669a1ef119c5512515f014be59ee6c8121e', name: SLOTS.action })), this.numberButtonType === "vertical" && !this.readOnly ? numberButtonsVertical : null, this.suffixText ? suffixText : null, this.numberButtonType === "horizontal" && !this.readOnly
            ? numberButtonsHorizontalUp
            : null, h(HiddenFormInputSlot, { key: 'efc80f0a385d1d56971473fde6862738cb06b446', component: this })), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, id: IDS.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
