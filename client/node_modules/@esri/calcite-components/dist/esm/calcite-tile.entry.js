...
import { b as slotChangeHasAssignedElement, t as toAriaBoolean } from './dom-b6dedd88.js';
import { c as componentFocusable, a as setComponentLoaded, s as setUpLoadableComponent } from './loadable-13e9ffb2.js';
...
const Tile = class {
    ...
    render() {
        const { disabled } = this;
        return (h(InteractiveContainer, { key: '1d62f354d4a18837e56dd446efc63dde66f977bf', disabled: disabled }, this.href ? (h("calcite-link", { disabled: disabled, href: this.href }, this.renderTile())) : (this.renderTile())));
    }
