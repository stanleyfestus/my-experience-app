 ...
 * v2.13.2
 */
import { r as registerInstance, h, H as Host, g as getElement, c as createEvent, e as readTask, F as Fragment } from './index-abe3b66e.js';
import { C as nodeListToArray, s as slotChangeGetAssignedElements, k as focusElementInGroup, g as getElementDir, D as filterDirectChildren, t as toAriaBoolean, H as getSlotAssignedElements } from './dom-b6dedd88.js';
import { g as guid } from './guid-9c230b6a.js';
import { a as calciteSize24, b as calciteSize32, d as calciteSize44 } from './core-1f5dba8b.js';
...
import { I as InteractiveContainer, u as updateHostInteraction } from './interactive-1a42577a.js';
...
const Tab = class {
    ...
    render() {
        ...
        return (h(Host, { key: '5b445405fc60d4af5d48e2b4b42880a47a85a1ed', "aria-labelledby": this.labeledBy, id: id }, h("div", { key: '724b67e8c277d00f6408aa55f781ad8e91a34a5e', class: { [CSS$2.container]: true, [`scale-${this.scale}`]: true }, role: "tabpanel", tabIndex: this.selected ? 0 : -1 }, h("section", { key: '9a395308243994365184c0f91d8a16de357c9146', class: CSS$2.content }, h("slot", { key: '0cddbc27b9d793c83fa580b9aa9c9f915675ec72' })))));
    }
    connectedCallback() {
...
const TabTitle = class {
    ...
    render() {
        ...
        const iconStartEl = (h("calcite-icon", { key: '367d0a3590f1b47a36fcef27a4c361b2b738769a', class: { [CSS.titleIcon]: true, [CSS.iconStart]: true }, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: getIconScale(this.scale) }));
        const iconEndEl = (h("calcite-icon", { key: 'd41dab345260f907ad3b00538117c576856672fd', class: { [CSS.titleIcon]: true, [CSS.iconEnd]: true }, flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: getIconScale(this.scale) }));
        return (h(Host, { key: 'f5f5339ebcead5f63154d4b8f562782d20e30b06', "aria-controls": this.controls, "aria-selected": toAriaBoolean(this.selected), id: id, role: "tab", tabIndex: this.selected && !this.disabled ? 0 : -1 }, h(InteractiveContainer, { key: '0115c7e0367be91f3a9014243fb99cecd48d5f79', disabled: this.disabled }, h("div", { key: '7303b10302cfc93c03386036d98aa46a6b74afa7', class: {
            ...
            }, hidden: closed, ref: (el) => this.resizeObserver?.observe(el) }, h("div", { key: 'af603e50b1a853f3e4ca35357ae7778ca9bdaafb', class: { [CSS.content]: true, [CSS.contentHasText]: this.hasText } }, this.iconStart ? iconStartEl : null, h("slot", { key: 'a650492336b0f78f11c0d534351b0ab570dd1db8' }), this.iconEnd ? iconEndEl : null), this.renderCloseButton(), h("div", { key: '8d8a0438c867cdf0c2642b9a9bc7ce697aabb871', class: CSS.selectedIndicator })))));
    }
    renderCloseButton() {
