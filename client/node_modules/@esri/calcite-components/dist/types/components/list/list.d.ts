 ...
 */
export declare class List implements InteractiveComponent, LoadableComponent, LocalizedComponent, SortableComponent, T9nComponent {
    /**
     ...
     */
    filterProps: string[];
    handleFilterPropsChange(): Promise<void>;
    /**
    ...
    private allParentListItemsOpen;
    private borderItems;
    private updateFilteredItems;
    private updateFilteredData;
    private filterAndUpdateData;
