 ...
 */
export declare class Chip implements InteractiveComponent, LoadableComponent, LocalizedComponent, T9nComponent {
     ...
     * @internal
     */
    calciteInternalChipSelect: EventEmitter<void>;
    /**
     * @internal
     */
    calciteInternalSyncSelectedChips: EventEmitter<void>;
    ...
    private handleSelectionPropertyChange;
