...
import { FlipContext, Position, Scale, IconType } from "../interfaces";
 ...
 */
export declare class AccordionItem implements ConditionalSlotComponent, LoadableComponent {
