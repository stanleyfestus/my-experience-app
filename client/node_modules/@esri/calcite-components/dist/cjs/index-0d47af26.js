...
const timeZones = require('./time-zones-d998b788.js');
const region = require('./region-0e49528b.js');
require('./index-p4VH55K1-4b24d606.js');
...
const generateTimeZoneMetadata = (timeZoneItems, startDate, numberDays, dateEngine) => {
    ...
    return timeZoneItems.map((tzItem) => {
        ...
        return {
            ...tzItem,
            continent,
            isRegularContinent: continent !== region.global,
            dates,
        };
    });
};
...
const getGroupLabelTimeZoneIndices = (rawTZs, max = 5) => {
    const shrinkedTzs = rawTZs.filter(({ label }) => region.extractRegion(label) !== region.global);
...
//# sourceMappingURL=index-0d47af26.js.map