...
const Link = class {
    ...
    render() {
        ...
        const iconStartEl = (index.h("calcite-icon", { key: 'c9844033e9bd5da35333b485aad27ddb2df6b039', class: "calcite-link--icon icon-start", flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: "s" }));
        const iconEndEl = (index.h("calcite-icon", { key: 'f1de10682fee566552253cf2ae3cb6725f5e5f11', class: "calcite-link--icon icon-end", flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: "s" }));
        const Tag = childElType;
        const role = childElType === "span" ? "link" : null;
        const tabIndex = childElType === "span" ? 0 : null;
        return (index.h(index.Host, { key: '5ad440468fcccb6fe7c146ec57462e7593f96109', role: "presentation" }, index.h(interactive.InteractiveContainer, { key: '916c68cd97c31fa1ec69f408d25d3023749698e1', disabled: this.disabled }, index.h(Tag, { key: 'e00cebc0c56b95c02192872ac84df996a74a5fa4', class: { [resources.CSS_UTILITY.rtl]: dir === "rtl" },
            /*
          ...
          */
            download: childElType === "a"
                ? download === true || download === ""
                    ? ""
                    : download || null
                : null, href: childElType === "a" && this.href, onClick: this.childElClickHandler, ref: this.storeTagRef, rel: childElType === "a" && this.rel, role: role, tabIndex: tabIndex, target: childElType === "a" && this.target }, this.iconStart ? iconStartEl : null, index.h("slot", { key: '57b25ff3b8f7f3d048796a559c2911178d6b8ddf' }), this.iconEnd ? iconEndEl : null))));
    }
    //--------------------------------------------------------------------------
    //
    //  Events
