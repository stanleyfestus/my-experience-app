...
const TabTitle = class {
    ...
    render() {
        ...
        const iconStartEl = (index.h("calcite-icon", { key: '367d0a3590f1b47a36fcef27a4c361b2b738769a', class: { [CSS.titleIcon]: true, [CSS.iconStart]: true }, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: component.getIconScale(this.scale) }));
        const iconEndEl = (index.h("calcite-icon", { key: 'd41dab345260f907ad3b00538117c576856672fd', class: { [CSS.titleIcon]: true, [CSS.iconEnd]: true }, flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: component.getIconScale(this.scale) }));
        return (index.h(index.Host, { key: 'f5f5339ebcead5f63154d4b8f562782d20e30b06', "aria-controls": this.controls, "aria-selected": dom.toAriaBoolean(this.selected), id: id, role: "tab", tabIndex: this.selected && !this.disabled ? 0 : -1 }, index.h(interactive.InteractiveContainer, { key: '0115c7e0367be91f3a9014243fb99cecd48d5f79', disabled: this.disabled }, index.h("div", { key: '7303b10302cfc93c03386036d98aa46a6b74afa7', class: {
            ...
            }, hidden: closed, ref: (el) => this.resizeObserver?.observe(el) }, index.h("div", { key: 'af603e50b1a853f3e4ca35357ae7778ca9bdaafb', class: { [CSS.content]: true, [CSS.contentHasText]: this.hasText } }, this.iconStart ? iconStartEl : null, index.h("slot", { key: 'a650492336b0f78f11c0d534351b0ab570dd1db8' }), this.iconEnd ? iconEndEl : null), this.renderCloseButton(), index.h("div", { key: '8d8a0438c867cdf0c2642b9a9bc7ce697aabb871', class: CSS.selectedIndicator })))));
    }
    renderCloseButton() {
...
const Tabs = class {
    ...
    disconnectedCallback() { }
    render() {
        return (index.h(index.Fragment, { key: 'd06e888984e54b6b91b3345b42c217d322b46a64' }, index.h("slot", { key: 'd42da82a176cc1ad492cf1c548b96fc0ca53bc73', name: SLOTS.titleGroup }), index.h("section", { key: '21e944ce899b9bb2507fc9d9be81d8faa4a1a610' }, index.h("slot", { key: '25d4cd299d8529392f6b01deefd3356f8cd6050b', onSlotchange: this.defaultSlotChangeHandler, ref: this.setDefaultSlotRef }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
