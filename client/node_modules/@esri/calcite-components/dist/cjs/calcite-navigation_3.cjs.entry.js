...
const CalciteNavigation = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'bf64aa6c6c41bfad6413b58f7897527bb62e1d96' }, index.h("div", { key: '8c30501a94d5c41e60291c1f0d1cb2856afa5d62', class: {
            ...
            } }, index.h("div", { key: 'ef4c088fc24566ca24da9abe6a30903fedcad4d9', class: { [CSS$2.hide]: !this.progressSlotHasElement, [SLOTS.progress]: true } }, index.h("slot", { key: '0abc91e366b542e11ee76f13f099ee8b64a55ee0', name: SLOTS.progress, onSlotchange: this.handleProgressSlotChange })), index.h("div", { key: '689dc16c2ab71944a78f3bfc16c1c16c9159f073', class: { [CSS$2.containerContent]: true, [CSS$2.hasProgress]: this.progressSlotHasElement } }, this.renderMenuAction(), index.h("div", { key: '122f9d2d278a0a87dc1774f4933a4bb120410e48', class: { [CSS$2.hide]: !this.logoSlotHasElements, [SLOTS.logo]: true } }, index.h("slot", { key: '38f2a0106cb2b3a844b60406c629c0cff4c1b64e', name: SLOTS.logo, onSlotchange: this.handleLogoSlotChange })), index.h("slot", { key: 'af8aa2c6ed65c95c51ebe31314cd1e684beef657', name: SLOTS.contentStart, onSlotchange: this.handleContentStartSlotChange }), index.h("slot", { key: '989ba0f344ce973ea32b07ee02b04d62068cefb8', name: SLOTS.contentCenter, onSlotchange: this.handleContentCenterSlotChange }), index.h("slot", { key: 'e0fd2d40efb52e8735ca426c1374a3da4882a77d', name: SLOTS.contentEnd, onSlotchange: this.handleContentEndSlotChange }), index.h("div", { key: '56e905fef7a76fd14be7085f367d6abf8b44a80b', class: { [CSS$2.hide]: !this.userSlotHasElements, [SLOTS.user]: true } }, index.h("slot", { key: 'e038f1510da60abbb05c1fd8541563334f86f6d5', name: SLOTS.user, onSlotchange: this.handleUserSlotChange })))), index.h(index.Fragment, { key: '3a65439c3774cfb42fa6bc5f12c234a66f8bb314' }, index.h("slot", { key: '52e0b810e42911da6dc1ea448026f5756df0206f', name: SLOTS.navSecondary, onSlotchange: this.handleSecondarySlotChange }), index.h("slot", { key: '97c2666bcd896fa763cb84d6b53285e2e26b51d1', name: SLOTS.navTertiary, onSlotchange: this.handleTertiarySlotChange }))));
    }
...
const CalciteNavigationLogo = class {
    ...
    renderIcon() {
        ...
        return index.h("calcite-icon", { class: CSS$1.icon, flipRtl: this.iconFlipRtl, icon: this.icon, scale: "l" });
    }
    renderHeaderContent() {
        ...
        const descriptionNode = description ? (index.h("span", { class: CSS$1.description, key: CSS$1.description }, description)) : null;
        return headingNode || descriptionNode ? (index.h("div", { class: CSS$1.container, key: CSS$1.container }, headingNode, descriptionNode)) : null;
    }
    render() {
        const { thumbnail } = this;
        return (index.h(index.Host, { key: '40dcb76c1c7919fd1a8b6929616d1d507c1e3301' }, index.h("a", { key: '7b457d99add3c3d4edbd4478711f9b9c9fb12caf', class: CSS$1.anchor, href: this.href, rel: this.rel, target: this.target }, thumbnail && index.h("img", { key: '592aa3cfc2dfa47f9aa603f7edce4521dbaa27ae', alt: this.label || "", class: CSS$1.image, src: thumbnail }), this.icon && this.renderIcon(), this.renderHeaderContent())));
    }
...
//# sourceMappingURL=calcite-navigation_3.cjs.entry.js.map