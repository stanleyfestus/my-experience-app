...
const InputText = class {
    ...
    render() {
        ...
        const loader = (index.h("div", { key: '2ca041a581304297694d2219c52e3567ee39c4d9', class: CSS.loader }, index.h("calcite-progress", { key: 'dfc05d226e43048d229f32e830ce2d1295d5691f', label: this.messages.loading, type: "indeterminate" })));
        const inputClearButton = (index.h("button", { key: '39f2afe7d3280b4de0b4e8970266886a7119e5ba', "aria-label": this.messages.clear, class: CSS.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputTextValue, tabIndex: -1, type: "button" }, index.h("calcite-icon", { key: 'c16107371113f3015fb8d259d7a0b227c4256f8f', icon: "x", scale: component.getIconScale(this.scale) })));
        const iconEl = (index.h("calcite-icon", { key: 'f5dc6921fbe712ebda049e863bc8b2372083a4d1', class: CSS.inputIcon, flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: component.getIconScale(this.scale) }));
        const prefixText = index.h("div", { key: 'b295b7306b9d121c47f1129f743429de65166bc3', class: CSS.prefix }, this.prefixText);
        const suffixText = index.h("div", { key: '85c5d7ba85182aecc7bf5471c96ce96507953948', class: CSS.suffix }, this.suffixText);
        const childEl = (index.h("input", { key: 'b542aedd945ae0c3ec2a8e6bc2f2f22f5040636c', "aria-errormessage": IDS.validationMessage, "aria-invalid": dom.toAriaBoolean(this.status === "invalid"), "aria-label": label.getLabelText(this), autocomplete: this.autocomplete, autofocus: this.el.autofocus ? true : null, class: {
        ...
        return (index.h(index.Host, { key: '5a32059d58fc667ccef836b97c7dbf9c7d0456ba', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, index.h(interactive.InteractiveContainer, { key: '06f4302d0b97901f9f962f6b96460c517a0e415d', disabled: this.disabled }, index.h("div", { key: 'f160e1bebeee50b752d6f38fbc2517952fb92c94', class: { [CSS.inputWrapper]: true, [resources.CSS_UTILITY.rtl]: dir === "rtl" }, ref: (el) => (this.inputWrapperEl = el) }, this.prefixText ? prefixText : null, index.h("div", { key: '72b7e6c7ffdd700779f0ab266050bf263a5912c5', class: CSS.wrapper }, childEl, this.isClearable ? inputClearButton : null, this.requestedIcon ? iconEl : null, this.loading ? loader : null), index.h("div", { key: 'b359ff4cad35756cf2b4fd97087071cfb8cb6363', class: CSS.actionWrapper, ref: (el) => (this.actionWrapperEl = el) }, index.h("slot", { key: '123667cff5ed426e732c9b5ef716147431d10ac5', name: SLOTS.action })), this.suffixText ? suffixText : null, index.h(form.HiddenFormInputSlot, { key: 'fb9c298c3ad9b1b67f6e9e8cc2fb9e7b96f010dd', component: this })), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, id: IDS.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
