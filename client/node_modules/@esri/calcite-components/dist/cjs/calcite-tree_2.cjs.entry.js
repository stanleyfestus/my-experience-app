...
const Tree = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5b08de1c59622b78985de9019bf4ba11d605a07f', "aria-multiselectable": this.child
                ? undefined
                : dom.toAriaBoolean(this.selectionMode === "multiple" || this.selectionMode === "multichildren"), onKeyDown: this.keyDownHandler, role: !this.child ? "tree" : undefined, tabIndex: this.getRootTabIndex() }, index.h("slot", { key: '00a037cf92cb5facadc4b2961a9369b6ae0631f5' })));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const TreeItem = class {
    ...
    render() {
        ...
        const iconStartEl = (index.h("calcite-icon", { key: '251fd8b4ef328e3575268a914b823282d5810b3b', class: CSS.iconStart, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: component.getIconScale(this.scale) }));
        return (index.h(index.Host, { key: '9ca6542ef823f536919ef45e249a51acc560e5cd', "aria-checked": this.selectionMode === "multiple" ||
                this.selectionMode === "multichildren" ||
                ...
                this.selectionMode === "single-persist"
                ? dom.toAriaBoolean(this.selected)
                : undefined, "calcite-hydrated-hidden": hidden, role: "treeitem", tabIndex: this.disabled ? -1 : 0 }, index.h(interactive.InteractiveContainer, { key: 'b87535cef45f25a3d962f2ee7a2fe23030c09626', disabled: this.disabled }, index.h("div", { key: '2a4f1e4a647c80ef1d027b795814a03dd933db37', class: { [CSS.itemExpanded]: isExpanded } }, index.h("div", { key: '716fc1eac97264fe3186a0beee9e173415f93b83', class: CSS.nodeAndActionsContainer }, index.h("div", { key: '286db32250f9978cab481314b2ea3e790248c7f2', class: {
                [CSS.nodeContainer]: true,
                [resources.CSS_UTILITY.rtl]: rtl,
            }, "data-selection-mode": this.selectionMode }, chevron, itemIndicator, this.iconStart ? iconStartEl : null, checkbox ? checkbox : defaultSlotNode), index.h("div", { key: '2e1eeefae879f7197b5292ecda3b1f831f673efb', class: CSS.actionsEnd, hidden: !hasEndActions, ref: (el) => (this.actionSlotWrapper = el) }, slotNode)), index.h("div", { key: '1cb705ab7da1422b2a956ea90e29b489909840f3', class: {
                [CSS.childrenContainer]: true,
                [resources.CSS_UTILITY.rtl]: rtl,
            }, "data-test-id": "calcite-tree-children", onClick: this.childrenClickHandler, role: this.hasChildren ? "group" : undefined }, index.h("slot", { key: 'e3c968c15f50af07cafd3c3a67746455472e6b6f', name: SLOTS.children }))))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
