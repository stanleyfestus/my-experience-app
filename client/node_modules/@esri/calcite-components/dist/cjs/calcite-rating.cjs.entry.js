...
const StarIcon = ({ full, scale, partial }) => (index.h("calcite-icon", { class: partial ? undefined : "icon", icon: full ? "star-f" : "star", scale: scale }));
...
const Rating = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0e3159f00247860bc8c33e0913f9dd1e9248d887', onKeyDown: this.handleHostKeyDown, onPointerOut: this.handleRatingPointerOut, onPointerOver: this.handleRatingPointerOver }, index.h(interactive.InteractiveContainer, { key: '04013c4189a6c47e8c4ca61ee51b4b8491108964', disabled: this.disabled }, index.h("span", { key: '0fca81bc548e56b36cbf1695076517ba8204bef1', class: "wrapper" }, index.h("fieldset", { key: '30578fd314ff0e26c7963d5a9ad5bf787c4a6af0', class: "fieldset", disabled: this.disabled }, index.h("legend", { key: '18147ef049b4602781c7b7a2c102af81be7149d7', class: "visually-hidden" }, this.messages.rating), this.starsMap.map(({ average, checked, fraction, hovered, id, partial, selected, value, tabIndex, }) => {
        ...
        }), (this.count || this.average) && this.showChip ? (index.h("calcite-chip", { scale: this.scale, value: this.count?.toString() }, !!this.average && index.h("span", { class: "number--average" }, this.average.toString()), !!this.count && index.h("span", { class: "number--count" }, "(", this.count?.toString(), ")"))) : null), index.h(form.HiddenFormInputSlot, { key: '2aabd4db649ddc70a0b70d9f406f34e632676796', component: this })))));
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
