...
const TableRow = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fa3f14c832e7ed178ea338b01baebbe9a578689d' }, index.h(interactive.InteractiveContainer, { key: 'c82f005db0a6247e45476c86d2eaefe698df2dd1', disabled: this.disabled }, index.h("tr", { key: '452064805aa9685b75f3715bd45c42ce41f88368', "aria-rowindex": this.positionAll + 1, "aria-selected": dom.toAriaBoolean(this.selected), class: { [CSS.lastVisibleRow]: this.lastVisibleRow }, onKeyDown: this.keyDownHandler, ref: (el) => (this.tableRowEl = el) }, this.numbered && this.renderNumberedCell(), this.selectionMode !== "none" && this.renderSelectableCell(), index.h("slot", { key: 'bddf927a3129b20012ade6aa5415afcdeb8064a1', onSlotchange: this.updateCells, ref: (el) => (this.tableRowSlotEl = el) })))));
    }
