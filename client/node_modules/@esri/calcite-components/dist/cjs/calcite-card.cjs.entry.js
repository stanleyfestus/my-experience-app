...
const Card = class {
    constructor(hostRef) {
        ...
        this.handleThumbnailSlotChange = (event) => {
            this.hasThumbnail = dom.slotChangeHasAssignedElement(event);
        };
        this.handleHeadingSlotChange = (event) => {
            this.hasHeading = dom.slotChangeHasAssignedElement(event);
        };
        this.handleDescriptionSlotChange = (event) => {
            this.hasDescription = dom.slotChangeHasAssignedElement(event);
        };
        this.handleTitleSlotChange = (event) => {
            this.hasTitle = dom.slotChangeHasAssignedElement(event);
        };
        this.handleSubtitleSlotChange = (event) => {
            this.hasSubtitle = dom.slotChangeHasAssignedElement(event);
        };
        this.handleFooterStartSlotChange = (event) => {
            this.hasFooterStart = dom.slotChangeHasAssignedElement(event);
        };
        this.handleFooterEndSlotChange = (event) => {
            this.hasFooterEnd = dom.slotChangeHasAssignedElement(event);
        };
    ...
    renderThumbnail() {
        return (index.h("section", { class: CSS.thumbnailWrapper, hidden: !this.hasThumbnail }, index.h("slot", { name: SLOTS.thumbnail, onSlotchange: this.handleThumbnailSlotChange })));
    }
    renderSelectionIcon() {
    ...
    renderHeader() {
        ...
        return (index.h("header", { class: CSS.header, hidden: !showHeader }, this.selectable ? this.renderCheckboxDeprecated() : null, index.h("div", { class: CSS.headerTextContainer }, index.h("slot", { name: SLOTS.heading, onSlotchange: this.handleHeadingSlotChange }), index.h("slot", { name: SLOTS.description, onSlotchange: this.handleDescriptionSlotChange }), index.h("slot", { name: SLOTS.title, onSlotchange: this.handleTitleSlotChange }), index.h("slot", { name: SLOTS.subtitle, onSlotchange: this.handleSubtitleSlotChange })), this.selectionMode !== "none" && this.renderSelectionIcon()));
    }
    renderFooter() {
        const hasFooter = this.hasFooterStart || this.hasFooterEnd;
        return (index.h("footer", { class: CSS.footer, hidden: !hasFooter }, index.h("slot", { name: SLOTS.footerStart, onSlotchange: this.handleFooterStartSlotChange }), index.h("slot", { name: SLOTS.footerEnd, onSlotchange: this.handleFooterEndSlotChange })));
    }
    render() {
        ...
        const role = this.selectionMode === "multiple"
            ...
            : this.selectionMode !== "none"
                ? "radio"
                : undefined;
        return (index.h(index.Host, { key: 'dbb99f5c06440d5f7100f89bfef1febbd8d01f3e' }, index.h(interactive.InteractiveContainer, { key: '6fef7f69921c33bab4c66d34c0691821c837cc82', disabled: this.disabled }, index.h("div", { key: 'bcd3a1fecbfc39a15102099db8e6943b0e2207c5', "aria-checked": this.selectionMode !== "none" ? dom.toAriaBoolean(this.selected) : undefined, "aria-label": this.label, class: { [CSS.contentWrapper]: true, inline: thumbnailInline }, onClick: this.cardBodyClickHandler, onKeyDown: this.keyDownHandler, ref: (el) => (this.containerEl = el), role: role, tabIndex: !this.selectable || this.disabled ? 0 : -1 }, this.loading ? (index.h("div", { "aria-live": "polite", class: "calcite-card-loader-container" }, index.h("calcite-loader", { label: this.messages.loading }))) : null, thumbnailStart && this.renderThumbnail(), index.h("section", { key: '81c5383f8b09ce6372fd94a0e3c9e91c502a18bc', "aria-busy": dom.toAriaBoolean(this.loading), class: { [CSS.container]: true } }, this.renderHeader(), index.h("div", { key: '12d9564007bc07a3e0643ec0b097cab856968e02', class: {
                [CSS.cardContent]: true,
                [CSS.hasSlottedContent]: this.hasContent,
            } }, index.h("slot", { key: '1c500b0005123c768bfb77eecb62a0166c5e178f', onSlotchange: this.handleDefaultSlotChange })), this.renderFooter()), !thumbnailStart && this.renderThumbnail()))));
    }
