...
const Sheet = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '145f45b21fa18a08af4ef4e920d536a7e6431175', "aria-describedby": this.contentId, "aria-label": this.label, "aria-modal": "true", role: "dialog" }, index.h("div", { key: '796deb8baa890ad7e8f42d2e0a3be22269e450a2', class: {
                [CSS.container]: true,
                [CSS.containerOpen]: this.opened,
                [CSS.containerEmbedded]: this.embedded,
                [resources.CSS_UTILITY.rtl]: dir === "rtl",
            }, ref: this.setTransitionEl }, index.h("calcite-scrim", { key: 'c4d45b89ee32da639d1feb88289d2b0957474414', class: CSS.scrim, onClick: this.handleOutsideClose }), index.h("div", { key: 'ad764ed7812ca7172b5f4aacf4229ae28e06d315', class: {
                [CSS.content]: true,
            }, ref: this.setContentId }, index.h("slot", { key: 'dab54df7b8cae4bc8434935e1b55204896ed45df' })))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
