...
const Stepper = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cf7174442aa44f3a2bd72893900a60bcbf7e1d5e', "aria-label": this.messages.label, role: "region" }, index.h("div", { key: '1036b66baff637f74ca2296c725f8ec091955c55', class: { container: true, [CSS$2.singleView]: this.layout === "horizontal-single" }, ref: this.setContainerEl }, this.layout === "horizontal-single" && (index.h("div", { key: '2ebc80f63ea8938538630181ac165712ce645b69', class: { [CSS$2.stepBarContainer]: true } }, this.items.map((item, index$1) => (index.h(StepBar, { active: index$1 === this.currentActivePosition, complete: item.complete && index$1 !== this.currentActivePosition && !item.error, disabled: item.disabled && index$1 !== this.currentActivePosition, error: item.error && index$1 !== this.currentActivePosition, key: index$1 }))))), this.layout === "horizontal-single" && (index.h("div", { key: 'c471f0b44071da745850a7a5910894f27eccce02', class: { [CSS$2.actionContainer]: true } }, this.renderAction("start"), this.renderAction("end"))), index.h("slot", { key: 'd7f6599abe59d4ed86e0deefe991a3556fe3e270', onSlotchange: this.handleDefaultSlotChange }))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const StepperItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '21ead444066e7670e2884bf44eb33b1d6e16278e', "aria-current": this.selected ? "step" : "false", onClick: this.handleItemClick, onKeyDown: this.keyDownHandler, tabIndex: this.disabled ? -1 : 0 }, index.h(interactive.InteractiveContainer, { key: '5d687fcf0ca63a518df6ac408bce87adb8cf4141', disabled: this.disabled }, index.h("div", { key: 'a8eb28baf17f7d302cd8acc06c87432c2a5b59da', class: CSS.container }, this.complete && (index.h("span", { key: 'dd645ac0548cfb09daa4cb36d4ca08f7f3df67bf', "aria-live": "polite", class: CSS.visuallyHidden }, this.messages.complete)), index.h("div", { key: '6c14bec4509a8b48e08f3d140e852ce6441a7418', class: CSS.stepperItemHeader, ref: (el) => (this.headerEl = el), tabIndex: 
            /* additional tab index logic needed because of display: contents */
            this.layout === "horizontal" && !this.disabled ? 0 : null }, this.icon ? this.renderIcon() : null, this.numbered ? (index.h("div", { class: CSS.stepperItemNumber }, this.renderNumbers(), ".")) : null, index.h("div", { key: '49ebae3bd3affcdf6d68581e89d8a7c65b8606a6', class: CSS.stepperItemHeaderText }, index.h("span", { key: '523fbb51267df84902a47ccd4b2c047b52e7df07', class: CSS.stepperItemHeading }, this.heading), index.h("span", { key: 'f6c4f69b00a5e5d9f52089156ec77adecc1bdffc', class: CSS.stepperItemDescription }, this.description))), index.h("div", { key: '086f0f9320d3098de87d1e9f3728164a83caf35d', class: CSS.stepperItemContent }, index.h("slot", { key: '8e049fb74154fbce4d685d4d00ebca9b3ff57f63' }))))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
