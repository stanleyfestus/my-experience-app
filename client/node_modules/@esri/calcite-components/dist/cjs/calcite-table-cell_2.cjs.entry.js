...
const TableCell = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '810b40e485c0c6e0eee906d2429f90b2849f6596' }, index.h(interactive.InteractiveContainer, { key: '58e00494bada929bc60f2e70469a5728373514ff', disabled: this.disabled }, index.h("td", { key: '3c42de8c89375021694b762b438eee08ac7b95e1', class: {
...
const TableHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '447a58f1a2aa774bbe128ddd6f5d5c0a03bf7bc7' }, index.h("th", { key: 'ee6cf5d248ed63e8212ffc5614d9c72cd4854bda', "aria-colindex": this.parentRowType === "head" ? this.positionInRow : undefined, class: {
            ...
            }, colSpan: this.colSpan, onBlur: this.onContainerBlur, onFocus: this.onContainerFocus, ref: (el) => (this.containerEl = el), role: this.parentRowType === "head" ? "columnheader" : "rowheader", rowSpan: this.rowSpan, scope: scope, tabIndex: this.selectionCell ? 0 : staticCell ? -1 : 0 }, this.heading && index.h("div", { key: '549f6ea3faaa3fe66565de1d67567bfaa38cad50', class: CSS.heading }, this.heading), this.description && index.h("div", { key: '27f7b8de72e154917efd88d9d7f9653df65b0459', class: CSS.description }, this.description), this.selectionCell && this.selectionMode === "multiple" && (index.h("calcite-icon", { key: '41fb8e9cdc09f24c326d8edd70d600fee4920bc3', class: { [CSS.active]: indeterminate || checked }, icon: selectionIcon, scale: component.getIconScale(this.scale) })), (this.selectionCell || this.numberCell) && (index.h("span", { key: '119b6c72bd3cc17a19863841e02b04c2312e7984', "aria-live": this.focused ? "polite" : "off", class: CSS.assistiveText }, this.screenReaderText)))));
    }
    static get assetsDirs() { return ["assets"]; }
    get el() { return index.getElement(this); }
    static get watchers() { return {
