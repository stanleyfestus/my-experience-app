...
const ShellCenterRow = class {
    ...
    render() {
        const { el } = this;
        const contentNode = (index.h("div", { key: '8e0d7519d5bc01805337748d7b96d7f32f5be5fb', class: CSS$1.content }, index.h("slot", { key: 'a8c07dc2518cca396b43de1372d188643dd8174b' })));
        ...
        return index.h(index.Fragment, { key: 'b09007c50d4dcc62fb8b43402fa023918d82fe2c' }, children);
    }
    get el() { return index.getElement(this); }
};
