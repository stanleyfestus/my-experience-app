...
const resources = require('./resources-8979133c.js');
...
const Notice = class {
    ...
    render() {
        const { el } = this;
        const closeButton = (index.h("button", { key: '52f9306ebe945398929f68fe66615359836ba2d8', "aria-label": this.messages.close, class: CSS.close, onClick: this.close, ref: (el) => (this.closeButton = el) }, index.h("calcite-icon", { key: 'f3601ac9547c73219661eebc7e7470db5dee7b52', icon: "x", scale: component.getIconScale(this.scale) })));
        const hasActionEnd = dom.getSlotted(el, SLOTS.actionsEnd);
        return (index.h("div", { key: '3f8117ff7cdd08c92ce804ef4ac8af83003156a4', class: CSS.container, ref: this.setTransitionEl }, this.requestedIcon ? (index.h("div", { class: CSS.icon }, index.h("calcite-icon", { flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: component.getIconScale(this.scale) }))) : null, index.h("div", { key: '1b614ee86618bd5ce6e8834b466baf7d2564b5a1', class: CSS.content }, index.h("slot", { key: '19467ed9718a78c7530c2a08c727028d565dee7b', name: SLOTS.title }), index.h("slot", { key: '191e71caf2f2147c62fd6b73602e41d95dc27558', name: SLOTS.message }), index.h("slot", { key: 'd4fbf2b8aaa980cd24c5be89c6c8a36d091658f3', name: SLOTS.link })), hasActionEnd ? (index.h("div", { class: CSS.actionsEnd }, index.h("slot", { name: SLOTS.actionsEnd }))) : null, this.closable ? closeButton : null));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
