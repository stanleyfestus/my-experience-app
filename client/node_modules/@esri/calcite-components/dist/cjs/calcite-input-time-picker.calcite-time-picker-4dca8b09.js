...
const locale$1 = require('./locale-d86a5a22.js');
const focusTrapComponent = require('./focusTrapComponent-0d845485.js');
const math = require('./math-5c6cbb10.js');
...
const input = require('./input-4e31156b.js');
...
const supportedDayjsLocaleToLocaleConfigImport = new Map([
    ["ar", () => Promise.resolve().then(function () { return require('./ar-c7fb89e6.js'); })],
    ["bg", () => Promise.resolve().then(function () { return require('./bg-2262a932.js'); })],
    ["bs", () => Promise.resolve().then(function () { return require('./bs-3833b11a.js'); })],
    ["ca", () => Promise.resolve().then(function () { return require('./ca-6cf3302c.js'); })],
    ["cs", () => Promise.resolve().then(function () { return require('./cs-3690542e.js'); })],
    ["da", () => Promise.resolve().then(function () { return require('./da-d76c8300.js'); })],
    ["de", () => Promise.resolve().then(function () { return require('./de-14fe4135.js'); })],
    ["de-at", () => Promise.resolve().then(function () { return require('./de-at-8da7b718.js'); })],
    ["de-ch", () => Promise.resolve().then(function () { return require('./de-ch-c24a1687.js'); })],
    ["el", () => Promise.resolve().then(function () { return require('./el-509ced13.js'); })],
    ["en", () => Promise.resolve().then(function () { return en$1; })],
    ["en-au", () => Promise.resolve().then(function () { return require('./en-au-8f64b324.js'); })],
    ["en-ca", () => Promise.resolve().then(function () { return require('./en-ca-5fe01ad0.js'); })],
    ["en-gb", () => Promise.resolve().then(function () { return require('./en-gb-aa60eaf8.js'); })],
    ["es", () => Promise.resolve().then(function () { return require('./es-cff81270.js'); })],
    ["es-mx", () => Promise.resolve().then(function () { return require('./es-mx-62dce660.js'); })],
    ["et", () => Promise.resolve().then(function () { return require('./et-74dcb0ad.js'); })],
    ["fi", () => Promise.resolve().then(function () { return require('./fi-4d8124ff.js'); })],
    ["fr", () => Promise.resolve().then(function () { return require('./fr-86d6a6b7.js'); })],
    ["fr-ch", () => Promise.resolve().then(function () { return require('./fr-ch-e331294b.js'); })],
    ["he", () => Promise.resolve().then(function () { return require('./he-6f1561c2.js'); })],
    ["hi", () => Promise.resolve().then(function () { return require('./hi-a1548424.js'); })],
    ["hr", () => Promise.resolve().then(function () { return require('./hr-cd64ed5e.js'); })],
    ["hu", () => Promise.resolve().then(function () { return require('./hu-05549561.js'); })],
    ["id", () => Promise.resolve().then(function () { return require('./id-f30585f7.js'); })],
    ["it", () => Promise.resolve().then(function () { return require('./it-9001c11d.js'); })],
    ["it-ch", () => Promise.resolve().then(function () { return require('./it-ch-4f1e394c.js'); })],
    ["ja", () => Promise.resolve().then(function () { return require('./ja-60783de8.js'); })],
    ["ko", () => Promise.resolve().then(function () { return require('./ko-ee8f8466.js'); })],
    ["lt", () => Promise.resolve().then(function () { return require('./lt-af6d629b.js'); })],
    ["lv", () => Promise.resolve().then(function () { return require('./lv-976b3d02.js'); })],
    ["mk", () => Promise.resolve().then(function () { return require('./mk-2ca659ca.js'); })],
    ["nl", () => Promise.resolve().then(function () { return require('./nl-db4cdd91.js'); })],
    ["nb", () => Promise.resolve().then(function () { return require('./nb-f5a899e2.js'); })],
    ["pl", () => Promise.resolve().then(function () { return require('./pl-712a2d0e.js'); })],
    ["pt", () => Promise.resolve().then(function () { return require('./pt-bd02096d.js'); })],
    ["pt-br", () => Promise.resolve().then(function () { return require('./pt-br-2744c249.js'); })],
    ["ro", () => Promise.resolve().then(function () { return require('./ro-91ef96df.js'); })],
    ["ru", () => Promise.resolve().then(function () { return require('./ru-266f9f20.js'); })],
    ["sk", () => Promise.resolve().then(function () { return require('./sk-1fafe6a2.js'); })],
    ["sl", () => Promise.resolve().then(function () { return require('./sl-2c7c04d7.js'); })],
    ["sr", () => Promise.resolve().then(function () { return require('./sr-0e64de63.js'); })],
    ["sv", () => Promise.resolve().then(function () { return require('./sv-175e0a4d.js'); })],
    ["th", () => Promise.resolve().then(function () { return require('./th-490dcf72.js'); })],
    ["tr", () => Promise.resolve().then(function () { return require('./tr-7ddb41a2.js'); })],
    ["uk", () => Promise.resolve().then(function () { return require('./uk-3f95b777.js'); })],
    ["vi", () => Promise.resolve().then(function () { return require('./vi-cb780e6a.js'); })],
    ["zh-cn", () => Promise.resolve().then(function () { return require('./zh-cn-54d01c56.js'); })],
    ["zh-hk", () => Promise.resolve().then(function () { return require('./zh-hk-0e536a6c.js'); })],
    ["zh-tw", () => Promise.resolve().then(function () { return require('./zh-tw-98201d18.js'); })],
]);
...
const InputTimePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7d5021d0867938190a71ecc258687504668aa919', onBlur: this.hostBlurHandler, onKeyDown: this.keyDownHandler }, index.h(interactive.InteractiveContainer, { key: '3df503ada54e8259f0e4e7013191942e4bc17020', disabled: this.disabled }, index.h("div", { key: '748dd86d90db29b4baaa1af42839b3b234e54d0b', class: "input-wrapper", onClick: this.onInputWrapperClick }, index.h("calcite-input-text", { key: 'af404dc58cb00afb62ecef587db4426bfc7b3495', "aria-autocomplete": "none", "aria-errormessage": IDS.validationMessage, "aria-haspopup": "dialog", "aria-invalid": dom.toAriaBoolean(this.status === "invalid"), disabled: disabled, icon: "clock", label: label.getLabelText(this), lang: this.effectiveLocale, onCalciteInputTextInput: this.calciteInternalInputInputHandler, onCalciteInternalInputTextFocus: this.calciteInternalInputFocusHandler, readOnly: readOnly, ref: this.setInputEl, role: "combobox", scale: this.scale, status: this.status }, !this.readOnly && this.renderToggleIcon(this.open))), index.h("calcite-popover", { key: '93f1e3a580ad988617e4959a2e379f03a5128bf0', autoClose: true, focusTrapDisabled: true, label: messages.chooseTime, lang: this.effectiveLocale, onCalcitePopoverBeforeClose: this.popoverBeforeCloseHandler, onCalcitePopoverBeforeOpen: this.popoverBeforeOpenHandler, onCalcitePopoverClose: this.popoverCloseHandler, onCalcitePopoverOpen: this.popoverOpenHandler, overlayPositioning: this.overlayPositioning, placement: this.placement, ref: this.setCalcitePopoverEl, referenceElement: this.calciteInputEl, triggerDisabled: true }, index.h("calcite-time-picker", { key: '264696f0f4187f69999b4d751ffbe02759214e78', lang: this.effectiveLocale, messageOverrides: this.messageOverrides, numberingSystem: this.numberingSystem, onCalciteInternalTimePickerChange: this.timePickerChangeHandler, ref: this.setCalciteTimePickerEl, scale: this.scale, step: this.step, tabIndex: this.open ? undefined : -1, value: this.value })), index.h(form.HiddenFormInputSlot, { key: '73e605e12a6de2c5480e392cbfbea09025243111', component: this }), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, id: IDS.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
    renderToggleIcon(open) {
        return (index.h("span", { class: CSS$1.toggleIcon, slot: "action" }, index.h("calcite-icon", { icon: open ? "chevron-up" : "chevron-down", scale: component.getIconScale(this.scale) })));
    }
...
//# sourceMappingURL=calcite-input-time-picker.calcite-time-picker-4dca8b09.js.map