...
const RadioButtonGroup = class {
    ...
    // --------------------------------------------------------------------------
    render() {
        return (index.h(index.Host, { key: '487c8e698a30bffc79b233b81faad9bab7ea17e5', role: "radiogroup" }, index.h("div", { key: '63cf9169798fefa62551fa0a975735ed2afd5a66', "aria-errormessage": IDS.validationMessage, "aria-invalid": dom.toAriaBoolean(this.status === "invalid"), class: CSS.itemWrapper }, index.h("slot", { key: 'a7274291fc93583ebdee167c3c1e2f71f7fa255c' })), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, id: IDS.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status })) : null));
    }
