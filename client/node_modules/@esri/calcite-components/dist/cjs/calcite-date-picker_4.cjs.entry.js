    ...
    render() {
        ...
        const maxDate = this.range && this.activeRange
            ? this.activeRange === "start"
                ...
                : this.maxAsDate
            : this.maxAsDate;
        return (index.h(index.Host, { key: '32213cf1e0848af340d9a7cdaf0838f88d04e0cb', onBlur: this.resetActiveDates, onKeyDown: this.keyDownHandler }, this.renderCalendar(activeDate, maxDate, minDate, date, endDate)));
    }
...
const DatePickerDay = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '99367dbc5f33128ec7e60922a7ccb68f54362f78', "aria-label": dayLabel, "aria-selected": dom.toAriaBoolean(this.active), id: dayId, onClick: this.onClick, onKeyDown: this.keyDownHandler, role: "button", tabIndex: this.active && !this.disabled ? 0 : -1 }, index.h(interactive.InteractiveContainer, { key: '50e5172f11d617e5e52aade2bb9fbdd7c46ccc60', disabled: this.disabled }, index.h("div", { key: 'cfb5af0dcdb9283e00d3220e3658c253fc8fdc05', "aria-hidden": "true", class: { "day-v-wrapper": true } }, index.h("div", { key: 'f1a85d642b0abdf35676fea5873c2ac4c92d451c', class: "day-wrapper" }, index.h("span", { key: '79daaedf22745c9d633b4461c5a28b828b6803ae', class: "day" }, index.h("span", { key: '14152896fce841cbe975eeabd5171024ae5133d3', class: "text" }, formattedDay)))))));
    }
    componentDidRender() {
...
const DatePickerMonthHeader = class {
    ...
    render() {
        return index.h("div", { key: '4943ff396e6db2ee2ba30f4994a75fb2d5afeda1', class: CSS.header }, this.renderContent());
    }
    renderContent() {
