...
const Tile = class {
    ...
    render() {
        const { disabled } = this;
        return (index.h(interactive.InteractiveContainer, { key: '1d62f354d4a18837e56dd446efc63dde66f977bf', disabled: disabled }, this.href ? (index.h("calcite-link", { disabled: disabled, href: this.href }, this.renderTile())) : (this.renderTile())));
    }
