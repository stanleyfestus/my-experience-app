...
const logger = require('./logger-11553bbd.js');
...
const Modal = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f92cd77f4a5ad4a245ca50fe2b2bfcf9966d4ca8', "aria-describedby": this.contentId, "aria-labelledby": this.titleId, "aria-modal": "true", role: "dialog" }, index.h("div", { key: 'a9d348a67842162f1bc17ec8422c07963aed412d', class: {
                [CSS.container]: true,
                [CSS.containerOpen]: this.opened,
                [CSS.containerEmbedded]: this.embedded,
            } }, index.h("calcite-scrim", { key: '7dc3bc9220fc375522a6d390b633f9573bfa6c67', class: CSS.scrim, onClick: this.handleOutsideClose }), this.renderStyle(), index.h("div", { key: '40782ba2b6d3f086c884ace3529110e873009504', class: {
                [CSS.modal]: true,
            }, ref: this.setTransitionEl }, index.h("div", { key: 'ea3a72ab0a0e5abae6e766d0b7b2cfce54667e86', class: CSS.header }, this.renderCloseButton(), index.h("header", { key: 'abe5c28d11fc6241cd6ac40adef4d94529eb9d5c', class: CSS.title }, index.h("slot", { key: '3d1d6ed6c0249472a00fba4128a861e6a6eae4dd', name: CSS.header }))), this.renderContentTop(), index.h("div", { key: '0e65dfbd175e490586518d1a4c34b9eb1dde1f01', class: {
                [CSS.content]: true,
                [CSS.contentNoFooter]: !this.hasFooter,
            }, ref: (el) => (this.modalContent = el) }, index.h("slot", { key: 'd5f3b08e61e8e47f64fd13bc6eb7f7ed6a07b7c8', name: SLOTS.content })), this.renderContentBottom(), this.renderFooter()))));
    }
    renderFooter() {
