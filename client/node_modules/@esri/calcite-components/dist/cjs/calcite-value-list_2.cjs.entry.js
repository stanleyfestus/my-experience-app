...
const resources = require('./resources-e894e7c0.js');
...
const ValueList = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b9e38d57ffd1d2b686264d87f809e712c33c5cc5', "aria-busy": dom.toAriaBoolean(this.loading), onBlur: this.handleBlur, onFocusin: this.handleFocusIn, onKeyDown: this.keyDownHandler, role: "menu" }, index.h(resources.List, { key: '18d18babe0959692bebdb17ec427b53fc4697b08', props: this })));
    }
