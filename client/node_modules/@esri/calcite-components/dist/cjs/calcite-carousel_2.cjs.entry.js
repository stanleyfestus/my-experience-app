...
const responsive = require('./responsive-9537ca58.js');
...
const Carousel = class {
    constructor(hostRef) {
        ...
        this.tabListKeyDownHandler = (event) => {
            ...
            switch (event.key) {
                case "ArrowRight":
                    dom.focusElementInGroup(visiblePaginationEls, currentEl, "next");
                    break;
                case "ArrowLeft":
                    dom.focusElementInGroup(visiblePaginationEls, currentEl, "previous");
                    break;
                case "Home":
                    event.preventDefault();
                    dom.focusElementInGroup(visiblePaginationEls, currentEl, "first");
                    break;
                case "End":
                    event.preventDefault();
                    dom.focusElementInGroup(visiblePaginationEls, currentEl, "last");
                    break;
            }
        };
        ...
        this.renderPaginationItems = () => {
            ...
            return (index.h("div", { "aria-label": label, class: CSS$1.paginationItems, role: "tablist" }, items.map((item, index$1) => {
                const itemCount = items.length;
                const match = index$1 === selectedIndex;
                const first = index$1 === 0;
                const last = index$1 === itemCount - 1;
                ...
                const isEdge = !first && !last && !match && (index$1 === low - 1 || index$1 === high);
                const visible = match || (index$1 <= high && index$1 >= low - 1);
                const overflowActive = itemCount - 1 <= maxItems;
                const icon = match ? ICONS.active : ICONS.inactive;
                return (index.h("button", { "aria-controls": !match ? item.id : undefined, "aria-selected": dom.toAriaBoolean(match), class: {
                        [CSS$1.paginationItem]: true,
                    ...
                    }, "data-index": index$1, key: item.id, onClick: handleItemSelection, role: "tab", title: item.label }, index.h("calcite-icon", { icon: icon, scale: "l" })));
            })));
        };
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c41171a3b16c6aad1b37f4631a2d123acaca752d' }, index.h(interactive.InteractiveContainer, { key: '03c90c14f2b3f948c0e349bede237d29ed292c7f', disabled: this.disabled }, index.h("div", { key: 'df9af99e67d3b9c61dd6ccac74e82237e8eb17c4', "aria-label": this.label, "aria-live": this.playing ? "off" : "polite", "aria-roledescription": this.messages.carousel, class: {
                [CSS$1.container]: true,
                [CSS$1.containerOverlaid]: this.controlOverlay,
                [CSS$1.containerEdged]: this.arrowType === "edge",
            }, onFocusin: this.handleFocusIn, onFocusout: this.handleFocusOut, onKeyDown: this.containerKeyDownHandler, onMouseEnter: this.handleMouseIn, onMouseLeave: this.handleMouseOut, ref: this.storeContainerRef, role: "group", tabIndex: 0 }, index.h("section", { key: '7c274a35b9186ba9bb04fd8124be6893eee46e5f', class: {
            ...
            ref: this.storeItemContainerRef }, index.h("slot", { key: '0f2497545f4cf4a311ab871bcaf5ff16fe677c77', onSlotchange: this.handleSlotChange })), this.items.length > 1 && this.renderPaginationArea(), this.arrowType === "edge" && this.renderArrow("previous"), this.arrowType === "edge" && this.renderArrow("next")))));
    }
...
const CarouselItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5606df99edd6007701f391f095c88270eed4ccf1', id: id }, index.h("div", { key: '7147a10dbb3fa9292da09207709bfa5e7e857bf9', "aria-label": this.label, class: { [CSS.container]: true, [CSS.selected]: this.selected }, role: "tabpanel" }, index.h("slot", { key: '8b6876c8fc55afd1cac458b97063f66dff2cd9e2' }))));
    }
    get el() { return index.getElement(this); }
};
