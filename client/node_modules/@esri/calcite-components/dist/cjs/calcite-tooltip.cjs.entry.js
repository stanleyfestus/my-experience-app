...
const FloatingArrow = require('./FloatingArrow-b74e0a8d.js');
...
const Tooltip = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4f097fd8c6eda6dfcd5734e5aaea1f52092501e7', "aria-hidden": dom.toAriaBoolean(hidden), "aria-label": label, "aria-live": "polite", "calcite-hydrated-hidden": hidden, id: this.getId(), role: "tooltip" }, index.h("div", { key: '6b5055ab6f95277dd4daeaaff15cb9848d85eea0', class: {
                [floatingUi.FloatingCSS.animation]: true,
                [floatingUi.FloatingCSS.animationActive]: displayed,
            }, ref: this.setTransitionEl }, index.h(FloatingArrow.FloatingArrow, { key: '57f68bea5a7bb369d82437f10535cab9753677ea', floatingLayout: floatingLayout, ref: (arrowEl) => (this.arrowEl = arrowEl) }), index.h("div", { key: '100b8318173849508952f996acaeb5bf81b8af43', class: CSS.container }, index.h("slot", { key: 'f89d3ae9313d9555e6a7acdc32c323de85319a3a' })))));
    }
