...
const throttle = require('./throttle-031b1bf5.js');
...
const TextArea = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '87f925e13e3a1bef5b85af59a4e61433c3262929' }, index.h(interactive.InteractiveContainer, { key: '3431b47034859c62b0d0116b5ff47189cd46ea0b', disabled: this.disabled }, index.h("textarea", { key: '78e60318dc05f03f0ec0f0738384b33a7e4ed546', "aria-describedby": this.guid, "aria-errormessage": IDS.validationMessage, "aria-invalid": dom.toAriaBoolean(this.status === "invalid" || this.isCharacterLimitExceeded()), "aria-label": label.getLabelText(this), autofocus: this.el.autofocus, class: {
                [CSS.textArea]: true,
                [CSS.readOnly]: this.readOnly,
                [CSS.textAreaInvalid]: this.isCharacterLimitExceeded(),
                [CSS.footerSlotted]: this.endSlotHasElements && this.startSlotHasElements,
                [CSS.textAreaOnly]: !hasFooter,
            }, cols: this.columns, disabled: this.disabled, name: this.name, onChange: this.handleChange, onInput: this.handleInput, placeholder: this.placeholder, readOnly: this.readOnly, ref: this.setTextAreaEl, required: this.required, rows: this.rows, value: this.value, wrap: this.wrap }), index.h("span", { key: '54d603509f65611918b788280124499ecf2161cf', class: { [CSS.content]: true } }, index.h("slot", { key: 'e1ffe00ed1eeb26899f372ea9d011da20bcddfeb', onSlotchange: this.contentSlotChangeHandler })), index.h("footer", { key: 'bb52300f3ba3568e0e325c7e620cb6f5c53cba37', class: {
                [CSS.footer]: true,
                [CSS.readOnly]: this.readOnly,
                [CSS.hide]: !hasFooter,
            }, ref: (el) => (this.footerEl = el) }, index.h("div", { key: 'a5c5c250493dab203789dd27ce187c817006c5be', class: {
                [CSS.container]: true,
                [CSS.footerEndSlotOnly]: !this.startSlotHasElements && this.endSlotHasElements,
            } }, index.h("slot", { key: 'a54c7b6ca529475fa59cf1849213cd0ec7bf8f9c', name: SLOTS.footerStart, onSlotchange: (event) => (this.startSlotHasElements = dom.slotChangeHasAssignedElement(event)) }), index.h("slot", { key: 'e14af1362fd85e7461c42dd10dfd188d10f59ab0', name: SLOTS.footerEnd, onSlotchange: (event) => (this.endSlotHasElements = dom.slotChangeHasAssignedElement(event)) })), this.renderCharacterLimit()), index.h(form.HiddenFormInputSlot, { key: 'b64b6dc288df7eadcf3eef9e17aa931732f4ad09', component: this }), this.isCharacterLimitExceeded() && (index.h("span", { key: 'fb2017a6f21f4590934d9a1118e5dc5ee29e1dd5', "aria-live": "polite", class: CSS.assistiveText, id: this.guid }, this.replacePlaceHoldersInMessages())), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, id: IDS.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
