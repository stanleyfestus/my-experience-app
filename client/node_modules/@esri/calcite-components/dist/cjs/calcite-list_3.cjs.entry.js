...
const sortableComponent = require('./sortableComponent-98c6e036.js');
const resources = require('./resources-20aef292.js');
...
const List = class {
    constructor(hostRef) {
        ...
        this.listItems = [];
        this.mutationObserver = observers.createObserver("mutation", () => this.updateListItems({ performFilter: true }));
        this.visibleItems = [];
        ...
        this.updateListItems = debounce.debounce((options) => {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { key: 'c3139afe4fe7c7462578a51a4578971c97473167', disabled: this.disabled }, index.h("div", { key: '5e99dc8b479c35609c5f0318723b3da84ec23ef4', class: CSS$1.container }, this.dragEnabled ? (index.h("span", { "aria-live": "assertive", class: CSS$1.assistiveText }, this.assistiveText)) : null, this.renderItemAriaLive(), loading ? index.h("calcite-scrim", { class: CSS$1.scrim, loading: loading }) : null, index.h("table", { key: 'a31ba050d3141351e491141365e8244ed3ca5303', "aria-busy": dom.toAriaBoolean(loading), "aria-label": label || "", class: CSS$1.table, onKeyDown: this.handleListKeydown, role: "treegrid" }, filterEnabled || hasFilterActionsStart || hasFilterActionsEnd ? (index.h("thead", { class: CSS$1.sticky }, index.h("tr", null, index.h("th", { colSpan: MAX_COLUMNS }, index.h("calcite-stack", { class: CSS$1.stack }, index.h("slot", { name: SLOTS.filterActionsStart, onSlotchange: this.handleFilterActionsStartSlotChange, slot: resources.SLOTS.actionsStart }), index.h("calcite-filter", { "aria-label": filterPlaceholder, disabled: disabled, filterProps: filterProps, items: dataForFilter, onCalciteFilterChange: this.handleFilterChange, placeholder: filterPlaceholder, ref: this.setFilterEl, value: filterText }), index.h("slot", { name: SLOTS.filterActionsEnd, onSlotchange: this.handleFilterActionsEndSlotChange, slot: resources.SLOTS.actionsEnd })))))) : null, index.h("tbody", { key: '3ed1b8d9a4387c3ea0f4ff38e5388be35b32d89b', class: CSS$1.tableContainer }, index.h("slot", { key: '712562533b4609749cbff0968bd0a9e77d99758e', onSlotchange: this.handleDefaultSlotChange }))), index.h("div", { key: '3ff977013e0ca0d58229e1305dca702000d91a99', "aria-live": "polite", "data-test-id": "no-results-container", hidden: !(hasFilterNoResults && filterEnabled && filterText && !filteredItems.length) }, index.h("slot", { key: '7c2bf6389c8b5f4b6f617950e4068baf6b1dc358', name: SLOTS.filterNoResults, onSlotchange: this.handleFilterNoResultsSlotChange })))));
    }
    // --------------------------------------------------------------------------
    //
    //  Private Methods
...
const ListItem = class {
    ...
    renderContentContainer() {
        ...
        return (index.h("td", { "aria-label": label, class: {
                ...
                [CSS$2.contentContainerUnavailable]: unavailable,
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a610ab740c82b6088400839884d58d4d867829db' }, index.h(interactive.InteractiveContainer, { key: 'f05bf10e82fab03ddfdaf3ab2e100dcbd6d69c63', disabled: disabled }, index.h("div", { key: '4bf63ed08d2a4a049e060d26d3699656558d495e', class: { [CSS$2.wrapper]: true, [CSS$2.wrapperBordered]: bordered } }, index.h("tr", { key: 'd231a113c3bd8ee7f67c2ffb0cf804c142a95fb9', "aria-expanded": openable ? dom.toAriaBoolean(open) : null, "aria-label": label, "aria-level": level, "aria-posinset": setPosition, "aria-selected": dom.toAriaBoolean(selected), "aria-setsize": setSize, class: {
...
const ListItemGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e1e0304c3d4fe02909fd0075de2e4f5ef806be39' }, index.h(interactive.InteractiveContainer, { key: '5fb0861fb58de90808e98b7061d3c906c822203c', disabled: disabled }, index.h("tr", { key: 'c77af78f937c3135601df2c4574b858662d5fcdb', class: CSS.container }, index.h("td", { key: 'f1ae6b9e09e78f87b814287f8eaeb0a105575c7a', class: CSS.heading, colSpan: MAX_COLUMNS }, heading)), index.h("slot", { key: '7346d5d774173403910eddd35bf700ccd1437c4f', onSlotchange: this.handleDefaultSlotChange }))));
    }
    get el() { return index.getElement(this); }
};
