...
module.exports = {
  meta: {
    ...
    docs: {
      description:
        'This rule facilitates the deprecation of `gutters` variables in the theme and provides automatic fixes to replace these gutter variables with specific values.',
      recommended: false,
    ...
    messages: {
      message:
        'Deprecate gutter variables in the theme and replace them with specific values. (\'{{oldVar}}\' → \'{{newVar}}\')',
    },
    schema: [
      {
        type: 'object',
  ...
  create(context) {
    ...
    return {
      MemberExpression(node) {
        ...
        let props = null
        if ((props = getMatchNodeIdentifiers(node, { value: [themeAliases, 'gutters', ['0', '1', '2', '3', '4', '5'],], stop: themeAliases }, { value: variables, level: 1 }))) {
