...
const ArcGISChartsBarLineChart = class {
    ...
    layerRendererChangePolicyCallBack(newRefreshOnLayerRenderer) {
        if (newRefreshOnLayerRenderer !== actionBarUtils.$m.Ignore) {
    ...
    async componentDidUpdate() {
        ...
        await actionBarUtils.zc([actionBarUtils.WebChartTypes.BarSeries, actionBarUtils.WebChartTypes.LineSeries], this.config);
    ...
    render() {
        ...
        const chartStyles = this.showNotifyPanel && this.notifyOptions?.kind === "danger"
            ...
            : `${actionBarUtils.WebChartTypes.ComboLineAndBarSeries} ${configUpdate.HTMLClasses.Show}`;
        const notifyStyles = this.showNotifyPanel
            ? `${configUpdate.HTMLClasses.Show} ${configUpdate.HTMLClasses.NotifyPanel}`
            : configUpdate.HTMLClasses.Hide;
        return (index.h(index.Host, { key: 'f9bc387e5f0afb795f242ff717efdeb8cf3db95a' }, index.h("slot", { key: '9679c83811e8b47ca0572edb44847a4e9138b436', name: actionBarUtils.Slot.actionBar, onSlotchange: (e) => {
                actionBarUtils.onActionBarSlotChange(e, actionBarUtils.WebChartTypes.ComboLineAndBarSeries, this.config);
            } }), index.h("div", { key: '6a44d153c15a066edd8bb54c46245dc9c36ec995', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), index.h("div", { key: '2ec2eef1cb884f7cc478222ee81711114f69dfb7', class: notifyStyles }, notifyPanel)));
    }
    /**
    ...
    async createChartInstance(firstCreation = true) {
        ...
        try {
            if (configUpdate.isValidDataSource(this.config, this.layer)) {
                ...
                this.chartCreationProcessing = configUpdate.WY({
...
exports.ArcGISChartsBarLineChart = ArcGISChartsBarLineChart;
