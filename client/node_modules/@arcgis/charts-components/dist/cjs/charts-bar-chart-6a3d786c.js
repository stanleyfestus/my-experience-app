...
const ArcGISChartsBarChart = class {
    ...
    render() {
        ...
        const notifyStyles = this.showNotifyPanel
            ...
            : configUpdate.HTMLClasses.Hide;
        return (index.h(index.Host, { key: 'f5ed43787f7704f2a3006354854eff63e5d51e6f' }, index.h("slot", { key: 'ca76d5c686f07553ef01a8de6a5bb750411cecb6', name: actionBarUtils.Slot.actionBar, onSlotchange: (e) => {
                actionBarUtils.onActionBarSlotChange(e, actionBarUtils.WebChartTypes.BarSeries, this.config);
            } }), index.h("div", { key: '6a2ee8034d4c84f579f52856492553a190e7784b', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), index.h("div", { key: 'b3b1ae6bb3370f5c3308bc5cb3a7fc6d9d5967ee', class: notifyStyles }, notifyPanel)));
    }
    /**
...
exports.ArcGISChartsBarChart = ArcGISChartsBarChart;
