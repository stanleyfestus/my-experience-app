...
const ArcGISChartsScatterPlotBeta = class {
            ...
            if (this.chart !== undefined) {
                ...
                if (updatedProps.length > 0) {
                    ...
                    await this.chart.update({
                        ...
                        updateOptions: configUpdate.gatherComponentOptions({
                            component: this,
    ...
    async componentDidUpdate() {
        ...
        await actionBarUtils.zc([actionBarUtils.WebChartTypes.ScatterSeries], this.config);
    ...
    render() {
        ...
        const chartStyles = this.showNotifyPanel && this.notifyOptions?.kind === "danger"
            ...
            : `${actionBarUtils.WebChartTypes.ScatterSeries} ${configUpdate.HTMLClasses.Show}`;
        const notifyStyles = this.showNotifyPanel
            ? `${configUpdate.HTMLClasses.Show} ${configUpdate.HTMLClasses.NotifyPanel}`
            : configUpdate.HTMLClasses.Hide;
        return (index.h(index.Host, { key: '2d82e187a912e8450faae7068220dcdadbd6a09c' }, index.h("slot", { key: 'd2a2ab5dddcb4ad6fe4f78b2bb9d34939839e3e5', name: actionBarUtils.Slot.actionBar, onSlotchange: (e) => {
                actionBarUtils.onActionBarSlotChange(e, actionBarUtils.WebChartTypes.ScatterSeries, this.config);
            } }), index.h("div", { key: '79aaa4d82a73904c11ebe3f1620809ac12e5d5f1', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), index.h("div", { key: '5f8857d41fdf49e800c511148129bc5263f9b1e0', class: notifyStyles }, notifyPanel)));
    }
    /**
        ...
        try {
            if (configUpdate.isValidDataSource(this.config, this.layer)) {
                this.chartCreationProcessing = index$1.IV({
                    ...
                    options: configUpdate.gatherComponentOptions({ component: this }),
...
exports.ArcGISChartsScatterPlotBeta = ArcGISChartsScatterPlotBeta;
