...
const ArcGISChartsLineChartBeta = class {
    ...
    render() {
        ...
        const notifyStyles = this.showNotifyPanel
            ...
            : configUpdate.HTMLClasses.Hide;
        return (index.h(index.Host, { key: 'e502f87a622aefe8c457212ce68cb161210c718b' }, index.h("slot", { key: '9e16dc827fe1d9999c63cba4d7e4829807d0274b', name: actionBarUtils.Slot.actionBar, onSlotchange: (e) => {
                actionBarUtils.onActionBarSlotChange(e, actionBarUtils.WebChartTypes.LineSeries, this.config);
            } }), index.h("div", { key: '02805395fe209d0de921ae181af44fd3446b8014', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), index.h("div", { key: '9f76c3fc4e0456b09728b451cd90005e21b51e56', class: notifyStyles }, notifyPanel)));
    }
    /**
...
exports.ArcGISChartsLineChartBeta = ArcGISChartsLineChartBeta;
