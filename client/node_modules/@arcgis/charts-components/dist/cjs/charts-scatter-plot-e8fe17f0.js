...
const ArcGISChartsScatterPlot = class {
    ...
    render() {
        ...
        const notifyStyles = this.showNotifyPanel
            ...
            : configUpdate.HTMLClasses.Hide;
        return (index.h(index.Host, { key: 'cda56227c8784c76f7a8f7f927635fcd3ead651f' }, index.h("slot", { key: '2f637af58c3b2449904f84aeabd0ad9156e31171', name: actionBarUtils.Slot.actionBar, onSlotchange: (e) => {
                actionBarUtils.onActionBarSlotChange(e, actionBarUtils.WebChartTypes.ScatterSeries, this.config);
            } }), index.h("div", { key: '51295eb9bc4dbdddd003f672a0bc1c32e2153eee', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), index.h("div", { key: 'e933b573a69f1243d84aaee9c47fd315b00097ac', class: notifyStyles }, notifyPanel)));
    }
    /**
...
ArcGISChartsScatterPlot.style = ArcgisChartsScatterPlotStyle0;

exports.ArcGISChartsScatterPlot = ArcGISChartsScatterPlot;
