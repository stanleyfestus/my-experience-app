...
const ArcGISChartsBoxPlot = class {
    ...
    async componentDidUpdate() {
        ...
        await actionBarUtils.zc([actionBarUtils.WebChartTypes.BoxPlotSeries, actionBarUtils.WebChartTypes.LineSeries], this.config);
    ...
    render() {
        ...
        const chartStyles = this.showNotifyPanel && this.notifyOptions?.kind === "danger"
            ? "hide"
            : `${actionBarUtils.WebChartTypes.BoxPlotSeries} show`;
        const notifyStyles = this.showNotifyPanel ? "show notifyPanel" : "hide";
        return (index.h(index.Host, { key: '72d33da0a1f571c69f152d5beb219f7e49dc162b' }, index.h("slot", { key: '7794e283dccd58db1ebc754618d2a57ca617d106', name: actionBarUtils.Slot.actionBar, onSlotchange: (e) => {
                actionBarUtils.onActionBarSlotChange(e, actionBarUtils.WebChartTypes.BoxPlotSeries, this.config);
            } }), index.h("div", { key: '849a3347e52f3df54d8dd6f61f25793a865fa3c0', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), index.h("div", { key: '0c9c6b38ab26a6ab0a3a5ee6daf3c9395756324d', class: notifyStyles }, notifyPanel)));
    }
    /**
    ...
    checkForIncompatibleChartVersion() {
        ...
        if (actionBarUtils.Pc(chartVersion).versionStatus ===
...
exports.ArcGISChartsBoxPlot = ArcGISChartsBoxPlot;
