...
const ArcGISChartsLineChart = class {
    ...
    async componentDidUpdate() {
        ...
        await actionBarUtils.zc([actionBarUtils.WebChartTypes.LineSeries], this.config);
    ...
    render() {
        ...
        const chartStyles = this.showNotifyPanel && this.notifyOptions?.kind === "danger"
            ...
            : `${actionBarUtils.WebChartTypes.LineSeries} ${configUpdate.HTMLClasses.Show}`;
        const notifyStyles = this.showNotifyPanel
            ? `${configUpdate.HTMLClasses.Show} ${configUpdate.HTMLClasses.NotifyPanel}`
            : configUpdate.HTMLClasses.Hide;
        return (index.h(index.Host, { key: 'e3b48587334479449a0913a9f0c45b2711097df4' }, index.h("slot", { key: '91879ea052d36f011dfe478d6a4f0da19fa8c354', name: actionBarUtils.Slot.actionBar, onSlotchange: (e) => {
                actionBarUtils.onActionBarSlotChange(e, actionBarUtils.WebChartTypes.LineSeries, this.config);
            } }), index.h("div", { key: '06b05be15b3a1575f76c60894b9e44aeb87f7a06', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), index.h("div", { key: '5e3497766b79ea0edaf2e55fe4575047f7416c0b', class: notifyStyles }, notifyPanel)));
    }
    /**
...
exports.ArcGISChartsLineChart = ArcGISChartsLineChart;
