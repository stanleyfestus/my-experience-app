...
const ArcGISChartsHistogram = class {
    ...
    async componentDidUpdate() {
        ...
        await actionBarUtils.zc([actionBarUtils.WebChartTypes.HistogramSeries], this.config);
    ...
    render() {
        ...
        const chartStyles = this.showNotifyPanel && this.notifyOptions?.kind === "danger"
            ...
            : `${actionBarUtils.WebChartTypes.HistogramSeries} ${configUpdate.HTMLClasses.Show}`;
        const notifyStyles = this.showNotifyPanel
            ? `${configUpdate.HTMLClasses.Show} ${configUpdate.HTMLClasses.NotifyPanel}`
            : configUpdate.HTMLClasses.Hide;
        return (index.h(index.Host, { key: '5c99e18e631d6fac241e7153de80f61cc791fab0' }, index.h("slot", { key: 'c6d3cf0737fbbf887f9c66480926f992e5a5ccbc', name: actionBarUtils.Slot.actionBar, onSlotchange: (e) => {
                actionBarUtils.onActionBarSlotChange(e, actionBarUtils.WebChartTypes.HistogramSeries, this.config);
            } }), index.h("div", { key: '8931fd6dc0753f005a9dbdad894da63ffdbe7e08', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), index.h("div", { key: 'fa4528b76ae6b4a7cdfa026cf11f67199ffd8fae', class: notifyStyles }, notifyPanel)));
    }
    /**
...
exports.ArcGISChartsHistogram = ArcGISChartsHistogram;
