...
import { u as updateLegendPosition, b as updateLegendVisibility, r as resetAxesBounds, f as fetchErrorsStrings, c as fetchCommonStrings, p as promise, g as gatherComponentOptions, l as addMissingSplitBySeries, d as gatherComponentGlobalOptions, m as maximumNumberOfSimultaneousUpdates, i as isValidDataSource, e as ArcgisChartsNotifyPanel, h as addLayerFilterListener, j as addLayerRendererListener, k as addExtentChangeListener, W as WY } from './config-update.js';
import { $ as $m, O as Om, L as Ln, z as zc, W as WebChartTypes, b as Ol, S as Slot, o as onActionBarSlotChange, P as Pc, e as WebChartVersionStatus, K as Kr } from './action-bar-utils.js';
...
const ArcGISChartsBoxPlot = /*@__PURE__*/ proxyCustomElement(class ArcGISChartsBoxPlot extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    async componentDidUpdate() {
        ...
        await zc([WebChartTypes.BoxPlotSeries, WebChartTypes.LineSeries], this.config);
    ...
    render() {
        ...
        const chartStyles = this.showNotifyPanel && this.notifyOptions?.kind === "danger"
            ? "hide"
            : `${WebChartTypes.BoxPlotSeries} show`;
        const notifyStyles = this.showNotifyPanel ? "show notifyPanel" : "hide";
        return (h(Host, { key: '72d33da0a1f571c69f152d5beb219f7e49dc162b' }, h("slot", { key: '7794e283dccd58db1ebc754618d2a57ca617d106', name: Slot.actionBar, onSlotchange: (e) => {
                onActionBarSlotChange(e, WebChartTypes.BoxPlotSeries, this.config);
            } }), h("div", { key: '849a3347e52f3df54d8dd6f61f25793a865fa3c0', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), h("div", { key: '0c9c6b38ab26a6ab0a3a5ee6daf3c9395756324d', class: notifyStyles }, notifyPanel)));
    }
    /**
    ...
    checkForIncompatibleChartVersion() {
        ...
        if (Pc(chartVersion).versionStatus ===
    ...
    static get style() { return ArcgisChartsBoxPlotStyle0; }
}, [1, "arcgis-charts-box-plot", {
        "config": [1040],
        "rotation": [516],
...
function defineCustomElement() {
    ...
    const components = ["arcgis-charts-box-plot"];
    components.forEach(tagName => { switch (tagName) {
        case "arcgis-charts-box-plot":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ArcGISChartsBoxPlot);
            }
            break;
    } });
}
...
export { ArcGISChartsBoxPlot as A, defineCustomElement as d };
