...
const ArcGISChartsBarLineChart = /*@__PURE__*/ proxyCustomElement(class ArcGISChartsBarLineChart extends HTMLElement {
     ...
     * @param {CustomEvent} event The event carrying the selected elements
     * @category Custom-event handler
     */
     ...
     * @param {boolean} newValue - The new value of the disableInteractions property
     */
    ...
    rotationChange(newRotation) {
        this.config = Ln(newRotation, this.config);
    }
    /**
    ...
    layerRendererChangePolicyCallBack(newRefreshOnLayerRenderer) {
        if (newRefreshOnLayerRenderer !== $m.Ignore) {
     ...
     * @param {NotifyOptions} [options] The options to customize the notification
     * @category Public
     */
    ...
    async componentDidUpdate() {
        ...
        await zc([WebChartTypes.BarSeries, WebChartTypes.LineSeries], this.config);
    ...
    render() {
        ...
        const chartStyles = this.showNotifyPanel && this.notifyOptions?.kind === "danger"
            ? HTMLClasses.Hide
            : `${WebChartTypes.ComboLineAndBarSeries} ${HTMLClasses.Show}`;
        const notifyStyles = this.showNotifyPanel
            ? `${HTMLClasses.Show} ${HTMLClasses.NotifyPanel}`
            : HTMLClasses.Hide;
        return (h(Host, { key: 'f9bc387e5f0afb795f242ff717efdeb8cf3db95a' }, h("slot", { key: '9679c83811e8b47ca0572edb44847a4e9138b436', name: Slot.actionBar, onSlotchange: (e) => {
                onActionBarSlotChange(e, WebChartTypes.ComboLineAndBarSeries, this.config);
            } }), h("div", { key: '6a44d153c15a066edd8bb54c46245dc9c36ec995', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), h("div", { key: '2ec2eef1cb884f7cc478222ee81711114f69dfb7', class: notifyStyles }, notifyPanel)));
    }
    /**
    ...
    static get style() { return ArcgisChartsBarLineChartStyle0; }
}, [1, "arcgis-charts-bar-line-chart", {
        "config": [1040],
        "rotation": [516],
        "actionMode": [513, "action-mode"],
        "cursorRange": [513, "cursor-range"],
        "legendPosition": [513, "legend-position"],
        "legendVisibility": [516, "legend-visibility"],
        "hideEmptySeries": [516, "hide-empty-series"],
        "view": [16],
        "layer": [16],
        "selectionData": [16],
        "returnSelectionOIDs": [516, "return-selection-o-i-ds"],
        "returnSelectionIndexes": [516, "return-selection-indexes"],
        "returnFeaturesExtent": [516, "return-features-extent"],
        "filterBySelection": [516, "filter-by-selection"],
        "disableInteractions": [516, "disable-interactions"],
        "queueChartCreation": [516, "queue-chart-creation"],
        "useAnimatedCharts": [516, "use-animated-charts"],
        "hideLicenceWatermark": [516, "hide-licence-watermark"],
        "enableResponsiveFeatures": [516, "enable-responsive-features"],
        "autoDisposeChart": [516, "auto-dispose-chart"],
        "placeholder": [513],
        "selectionTheme": [16],
        "setTimeBinningInfoWhenNotProvided": [516, "set-time-binning-info-when-not-provided"],
        "chartLimits": [16],
        "ignoreSmoothRenderingLimit": [516, "ignore-smooth-rendering-limit"],
        "tooltipFormatter": [16],
        "dataLabelFormatter": [16],
        "guideTooltipFormatter": [16],
        "xAxisLabelFormatter": [16],
        "yAxisLabelFormatter": [16],
        "messageOptions": [16],
        "errorPolicy": [513, "error-policy"],
        "disableTogglingLegendItems": [516, "disable-toggling-legend-items"],
        "hideLoaderAnimation": [516, "hide-loader-animation"],
        "runtimeDataFilters": [16],
        "usePopupTemplateFieldsInfo": [516, "use-popup-template-fields-info"],
        "layerFilterChangePolicy": [513, "layer-filter-change-policy"],
        "layerRendererChangePolicy": [513, "layer-renderer-change-policy"],
        "ignoreViewExtent": [516, "ignore-view-extent"],
        "updateSplitBySeries": [16],
        "showNotifyPanel": [32],
        "notify": [64],
        "errorAlert": [64],
        "resetZoom": [64],
...
function defineCustomElement() {
    ...
    const components = ["arcgis-charts-bar-line-chart"];
    components.forEach(tagName => { switch (tagName) {
        case "arcgis-charts-bar-line-chart":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ArcGISChartsBarLineChart);
            }
            break;
    } });
}
...
export { ArcGISChartsBarLineChart as A, defineCustomElement as d };
