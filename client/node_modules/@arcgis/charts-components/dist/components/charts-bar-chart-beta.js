...
const ArcGISChartsBarChartBeta = /*@__PURE__*/ proxyCustomElement(class ArcGISChartsBarChartBeta extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    async componentDidUpdate() {
        ...
        await zc([WebChartTypes.BarSeries], this.config);
    ...
    render() {
        ...
        const notifyStyles = this.showNotifyPanel
            ...
            : HTMLClasses.Hide;
        return (h(Host, { key: '6d65dfc5abe94e6fc6c8058882811d750305cecf' }, h("slot", { key: 'bc0548bd48426c26a2b7718f7321d84d17335d72', name: Slot.actionBar, onSlotchange: (e) => {
                onActionBarSlotChange(e, WebChartTypes.BarSeries, this.config);
            } }), h("div", { key: 'ddace17d4f919d28bfd343f9a600db78e6716945', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), h("div", { key: '9c2756f4e61c8a9f28c279044cda5a93b8999f0d', class: notifyStyles }, notifyPanel)));
    }
    /**
    ...
    static get style() { return ArcgisChartsBarChartBetaStyle0; }
}, [1, "arcgis-charts-bar-chart-beta", {
        "config": [1040],
        "rotation": [516],
...
function defineCustomElement() {
    ...
    const components = ["arcgis-charts-bar-chart-beta"];
    components.forEach(tagName => { switch (tagName) {
        case "arcgis-charts-bar-chart-beta":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ArcGISChartsBarChartBeta);
            }
            break;
    } });
}
...
export { ArcGISChartsBarChartBeta as A, defineCustomElement as d };
