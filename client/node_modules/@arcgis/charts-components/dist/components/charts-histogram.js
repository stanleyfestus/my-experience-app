...
const ArcGISChartsHistogram = /*@__PURE__*/ proxyCustomElement(class ArcGISChartsHistogram extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return ArcgisChartsHistogramStyle0; }
}, [1, "arcgis-charts-histogram", {
        "config": [1040],
        ...
        "clearSelection": [64],
        "refresh": [64]
    }, [[0, "arcgisChartsJSDataProcessComplete", "handleChartOutputDataChange"], [0, "arcgisChartsJSLegendItemVisibilityChange", "handleLegendItemVisibilityChanged"], [0, "arcgisChartsJSUpdateComplete", "handleUpdateCompleted"], [0, "arcgisChartsJSBadDataWarningRaise", "handleBadDataWarningRaise"], [0, "arcgisChartsJSSeriesColorChange", "handleSeriesColorsChange"], [0, "arcgisChartsJSAxesMinMaxChange", "handleAxesMinMaxChange"], [0, "arcgisChartsJSSelectionComplete", "handleSelection"], [0, "calciteAlertClose", "handleAlertClosed"]], {
        "view": ["viewChange"],
        "layer": ["layerChange"],
        "runtimeDataFilters": ["runtimeDataFiltersChange"],
        "disableInteractions": ["disableInteractionsChange"],
...
function defineCustomElement() {
    ...
    const components = ["arcgis-charts-histogram"];
    components.forEach(tagName => { switch (tagName) {
        case "arcgis-charts-histogram":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ArcGISChartsHistogram);
            }
            break;
    } });
}
...
export { ArcGISChartsHistogram as A, defineCustomElement as d };
