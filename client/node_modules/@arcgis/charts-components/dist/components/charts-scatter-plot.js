...
const ArcGISChartsScatterPlot = /*@__PURE__*/ proxyCustomElement(class ArcGISChartsScatterPlot extends HTMLElement {
    ...
    render() {
        ...
        const notifyStyles = this.showNotifyPanel
            ...
            : HTMLClasses.Hide;
        return (h(Host, { key: 'cda56227c8784c76f7a8f7f927635fcd3ead651f' }, h("slot", { key: '2f637af58c3b2449904f84aeabd0ad9156e31171', name: Slot.actionBar, onSlotchange: (e) => {
                onActionBarSlotChange(e, WebChartTypes.ScatterSeries, this.config);
            } }), h("div", { key: '51295eb9bc4dbdddd003f672a0bc1c32e2153eee', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), h("div", { key: 'e933b573a69f1243d84aaee9c47fd315b00097ac', class: notifyStyles }, notifyPanel)));
    }
    /**
    ...
    static get style() { return ArcgisChartsScatterPlotStyle0; }
}, [1, "arcgis-charts-scatter-plot", {
        "config": [1040],
...
function defineCustomElement() {
    ...
    const components = ["arcgis-charts-scatter-plot"];
    components.forEach(tagName => { switch (tagName) {
        case "arcgis-charts-scatter-plot":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ArcGISChartsScatterPlot);
            }
            break;
    } });
}
...
export { ArcGISChartsScatterPlot as A, defineCustomElement as d };
