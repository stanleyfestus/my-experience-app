...
const ArcGISChartsLineChartBeta = /*@__PURE__*/ proxyCustomElement(class ArcGISChartsLineChartBeta extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        ...
        const notifyStyles = this.showNotifyPanel
            ...
            : HTMLClasses.Hide;
        return (h(Host, { key: 'e502f87a622aefe8c457212ce68cb161210c718b' }, h("slot", { key: '9e16dc827fe1d9999c63cba4d7e4829807d0274b', name: Slot.actionBar, onSlotchange: (e) => {
                onActionBarSlotChange(e, WebChartTypes.LineSeries, this.config);
            } }), h("div", { key: '02805395fe209d0de921ae181af44fd3446b8014', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), h("div", { key: '9f76c3fc4e0456b09728b451cd90005e21b51e56', class: notifyStyles }, notifyPanel)));
    }
    /**
    ...
    static get style() { return ArcgisChartsLineChartBetaStyle0; }
...
function defineCustomElement() {
    ...
    const components = ["arcgis-charts-line-chart-beta"];
    components.forEach(tagName => { switch (tagName) {
        case "arcgis-charts-line-chart-beta":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ArcGISChartsLineChartBeta);
            }
            break;
    } });
}
...
export { ArcGISChartsLineChartBeta as A, defineCustomElement as d };
