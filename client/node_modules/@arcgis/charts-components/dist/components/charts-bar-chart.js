...
const ArcGISChartsBarChart = /*@__PURE__*/ proxyCustomElement(class ArcGISChartsBarChart extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        ...
        const notifyStyles = this.showNotifyPanel
            ...
            : HTMLClasses.Hide;
        return (h(Host, { key: 'f5ed43787f7704f2a3006354854eff63e5d51e6f' }, h("slot", { key: 'ca76d5c686f07553ef01a8de6a5bb750411cecb6', name: Slot.actionBar, onSlotchange: (e) => {
                onActionBarSlotChange(e, WebChartTypes.BarSeries, this.config);
            } }), h("div", { key: '6a2ee8034d4c84f579f52856492553a190e7784b', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), h("div", { key: 'b3b1ae6bb3370f5c3308bc5cb3a7fc6d9d5967ee', class: notifyStyles }, notifyPanel)));
    }
    /**
    ...
    static get style() { return ArcgisChartsBarChartStyle0; }
}, [1, "arcgis-charts-bar-chart", {
        "config": [1040],
        "rotation": [516],
...
function defineCustomElement() {
    ...
    const components = ["arcgis-charts-bar-chart"];
    components.forEach(tagName => { switch (tagName) {
        case "arcgis-charts-bar-chart":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ArcGISChartsBarChart);
            }
            break;
    } });
}
...
export { ArcGISChartsBarChart as A, defineCustomElement as d };
