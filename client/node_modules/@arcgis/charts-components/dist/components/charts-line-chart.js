...
const ArcGISChartsLineChart = /*@__PURE__*/ proxyCustomElement(class ArcGISChartsLineChart extends HTMLElement {
     ...
     * @param {NotifyOptions | undefined} [options] The options to customize the notification
     * @category Public
     */
    ...
    /**
     * Re-render the chart.
     * @param {boolean | string} [props.updateData] Indicates whether to fetch new data. Default: true.
     * @param {boolean | string} [props.updateExtent] Indicates whether the view's extent is to update. Default: false.
     * @param {boolean | string} [props.resetAxesBounds] Option to reset the axes bounds along with the refresh.
     * @category Public
     */
    async refresh(props) {
    ...
    async componentDidUpdate() {
        ...
        await zc([WebChartTypes.LineSeries], this.config);
    ...
    render() {
        ...
        const notifyStyles = this.showNotifyPanel
            ...
            : HTMLClasses.Hide;
        return (h(Host, { key: 'e3b48587334479449a0913a9f0c45b2711097df4' }, h("slot", { key: '91879ea052d36f011dfe478d6a4f0da19fa8c354', name: Slot.actionBar, onSlotchange: (e) => {
                onActionBarSlotChange(e, WebChartTypes.LineSeries, this.config);
            } }), h("div", { key: '06b05be15b3a1575f76c60894b9e44aeb87f7a06', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), h("div", { key: '5e3497766b79ea0edaf2e55fe4575047f7416c0b', class: notifyStyles }, notifyPanel)));
    }
    /**
    ...
    static get style() { return ArcgisChartsLineChartStyle0; }
}, [1, "arcgis-charts-line-chart", {
        "config": [1040],
        "rotation": [516],
...
function defineCustomElement() {
    ...
    const components = ["arcgis-charts-line-chart"];
    components.forEach(tagName => { switch (tagName) {
        case "arcgis-charts-line-chart":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ArcGISChartsLineChart);
            }
            break;
    } });
}
...
export { ArcGISChartsLineChart as A, defineCustomElement as d };
