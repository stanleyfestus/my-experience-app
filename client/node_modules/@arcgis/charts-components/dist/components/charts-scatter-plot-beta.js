...
const ArcGISChartsScatterPlotBeta = /*@__PURE__*/ proxyCustomElement(class ArcGISChartsScatterPlotBeta extends HTMLElement {
     ...
     * @param {NotifyOptions | undefined} [options] The options to customize the message
     * @category Public
     */
    ...
    async componentDidUpdate() {
        ...
        await zc([WebChartTypes.ScatterSeries], this.config);
    ...
    render() {
        ...
        const chartStyles = this.showNotifyPanel && this.notifyOptions?.kind === "danger"
            ? HTMLClasses.Hide
            : `${WebChartTypes.ScatterSeries} ${HTMLClasses.Show}`;
        const notifyStyles = this.showNotifyPanel
            ? `${HTMLClasses.Show} ${HTMLClasses.NotifyPanel}`
            : HTMLClasses.Hide;
        return (h(Host, { key: '2d82e187a912e8450faae7068220dcdadbd6a09c' }, h("slot", { key: 'd2a2ab5dddcb4ad6fe4f78b2bb9d34939839e3e5', name: Slot.actionBar, onSlotchange: (e) => {
                onActionBarSlotChange(e, WebChartTypes.ScatterSeries, this.config);
            } }), h("div", { key: '79aaa4d82a73904c11ebe3f1620809ac12e5d5f1', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), h("div", { key: '5f8857d41fdf49e800c511148129bc5263f9b1e0', class: notifyStyles }, notifyPanel)));
    }
    /**
    ...
    async createChartInstance(firstCreation = true) {
        ...
        try {
            if (isValidDataSource(this.config, this.layer)) {
                this.chartCreationProcessing = IV({
    ...
    static get style() { return ArcgisChartsScatterPlotBetaStyle0; }
}, [1, "arcgis-charts-scatter-plot-beta", {
        "config": [1040],
...
function defineCustomElement() {
    ...
    const components = ["arcgis-charts-scatter-plot-beta"];
    components.forEach(tagName => { switch (tagName) {
        case "arcgis-charts-scatter-plot-beta":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ArcGISChartsScatterPlotBeta);
            }
            break;
    } });
}
...
export { ArcGISChartsScatterPlotBeta as A, defineCustomElement as d };
