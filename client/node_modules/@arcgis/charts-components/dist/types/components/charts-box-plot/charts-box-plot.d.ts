...
import type { NotifyOptions, BarAndLineDataLabelFormatCallback, GuideTooltipFormatCallback, AxisLabelFormatCallback, MessageOptions, BoxPlotTooltipFormatCallback } from "@arcgis/charts-js";
import type { ValidationStatus, SelectionData, ActionModes, SeriesSymbolsMap, SelectionTheme, ChartElementLimit, CursorRange, DataWarningObject } from "@arcgis/charts-shared-utils";
import { LayerFilterChangePolicy, LayerRendererChangePolicy } from "@arcgis/charts-shared-utils";
 ...
 */
export declare class ArcGISChartsBoxPlot {
    /**
    ...
    private chart?;
    /**
     * The box plot HTML element.
     * @type {HTMLArcgisChartsBoxPlotElement}
     * @element
     */
    el: HTMLArcgisChartsBoxPlotElement;
    /**
     ...
     * If the layer is a SupportedLayer and the `view` property is provided, it will be used to access the FeatureLayerView instance in order to perform client-side queries.
     ...
     * by the config.
     * The default style from the property `fillSymbol` will be applied to the new series.
    ...
    /**
     * Listener on the view's extent changes
     * @type {IHandle | undefined}
     * @category Private
     */
     ...
     * @type {queueAsPromised<ChartOptions, void>}
     * @category Private
     */
