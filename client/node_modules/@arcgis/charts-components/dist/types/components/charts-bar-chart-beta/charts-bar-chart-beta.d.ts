...
import type { NotifyOptions, GuideTooltipFormatCallback, AxisLabelFormatCallback, MessageOptions } from "@arcgis/charts-js-next";
...
import { LayerFilterChangePolicy, LayerRendererChangePolicy, ErrorPolicy } from "@arcgis/charts-shared-utils";
 ...
 */
export declare class ArcGISChartsBarChartBeta {
    /**
     ...
     * @type {HTMLArcgisChartsBarChartBetaElement}
     * @element
     */
    el: HTMLArcgisChartsBarChartBetaElement;
    /**
     ...
     */
    viewChange(newView: __esri.MapView | __esri.SceneView | undefined, oldView: __esri.MapView | __esri.SceneView | undefined): Promise<void>;
    /**
