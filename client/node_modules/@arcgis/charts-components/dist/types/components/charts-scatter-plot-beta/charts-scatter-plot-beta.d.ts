...
import type { NotifyOptions, ScatterPlotLabelFormatCallback, GuideTooltipFormatCallback, AxisLabelFormatCallback, MessageOptions } from "@arcgis/charts-js-next";
 ...
 */
export declare class ArcGISChartsScatterPlotBeta {
    /**
     ...
     * @type {HTMLArcgisChartsScatterPlotBetaElement}
     * @element
     */
    el: HTMLArcgisChartsScatterPlotBetaElement;
    /**
