...
import type { WebChart, WebChartHistogramDataItem, CalculatedMinMaxBoundsPayload, LegendItemVisibility, WebChartLegendPositions, WebMapWebChart, WebChartDataFilters, SupportedLayer } from "@arcgis/charts-spec";
import type { NotifyOptions, HistogramLabelFormatCallback, GuideTooltipFormatCallback, AxisLabelFormatCallback, MessageOptions } from "@arcgis/charts-js";
import type { ValidationStatus, SelectionData, ActionModes, SeriesSymbolsMap, SelectionTheme, CursorRange, DataWarningObject } from "@arcgis/charts-shared-utils";
 ...
 */
export declare class ArcGISChartsHistogram {
    /**
    ...
    private chart?;
    /**
     * The histogram HTML element.
     * @type {HTMLArcgisChartsHistogramElement}
     * @element
     */
    el: HTMLArcgisChartsHistogramElement;
    /**
     ...
     * @event
     */
    arcgisDataProcessComplete: EventEmitter<WebChartHistogramDataItem>;
    /**
     ...
     */
    handleChartOutputDataChange(event: CustomEvent<WebChartHistogramDataItem>): void;
    /**
