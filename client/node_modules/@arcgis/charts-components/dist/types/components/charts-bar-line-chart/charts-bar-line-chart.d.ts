...
import type { WebChart, CalculatedMinMaxBoundsPayload, LegendItemVisibility, WebChartLegendPositions, WebMapWebChart, WebChartGenericDataItem, WebChartDataFilters, SupportedLayer } from "@arcgis/charts-spec";
...
import type { ValidationStatus, SelectionData, ActionModes, SeriesSymbolsMap, ChartElementLimit, SelectionTheme, CursorRange, DataWarningObject } from "@arcgis/charts-shared-utils";
 ...
 */
export declare class ArcGISChartsBarLineChart {
    /**
    ...
    private chart?;
    /**
     * The bar line chart HTML element.
     * @type {HTMLArcgisChartsBarLineChartElement}
     * @element
     */
    el: HTMLArcgisChartsBarLineChartElement;
    /**
    ...
    /**
     * Used to customize the number maximum of bars and markers allowed on the chart.
     ...
     * by the config.
     * The default style from the property `fillSymbol or `lineSymbol` will be applied to the new bar or line series.
