...
import type { WebChart, WebChartLegendPositions, WebMapWebChart, LegendItemVisibility, WebChartDataFilters, WebChartGenericDataItem, WebChartDataItem, SupportedLayer } from "@arcgis/charts-spec";
import type { NotifyOptions, PieChartLabelFormatCallback, PieChartLegendValueLabelFormatCallback, MessageOptions, PreRenderCallback } from "@arcgis/charts-js";
import type { ActionModes, ValidationStatus, SelectionData, SelectionTheme, ChartElementLimit, PieSlicesSymbols, DataWarningObject } from "@arcgis/charts-shared-utils";
 ...
 */
export declare class ArcGISChartsPieChart {
    /**
    ...
    private chart?;
    /**
     * The pie chart HTML element.
     * @type {HTMLArcgisChartsPieChartElement}
     * @element
     */
    el: HTMLArcgisChartsPieChartElement;
    /**
    ...
    placeholder?: string;
    /**
     * A callback function used to format the tooltips. If the returned string contains HTML tags they will be
     * interpreted as such.
     * The series properties `displayNumericValueOnTooltip` and `displayPercentageOnTooltip` will be ignored if a callback is provided.
    ...
    /**
     * A callback function used to format the data labels. If the returned string contains HTML tags they will be
     * interpreted as such.
     * The series properties `displayNumericValueOnDataLabel` and `displayPercentageOnDataLabel` will be ignored if a callback is provided.
     * @type {PieChartLabelFormatCallback | undefined}
     * @category Public
     * @default undefined
     */
    ...
    /**
     * Used to customize the number maximum of slices allowed on the chart.
     ...
     * or update of the chart, or render the elements up to the given limit.
     ...
     * Can be used to alter the config.series[0].slices property from instance.
     ...
     * @event
     */
    arcgisDataProcessComplete: EventEmitter<WebChartGenericDataItem>;
    /**
     ...
     * @event
     */
    arcgisDataFetchComplete: EventEmitter<WebChartDataItem[]>;
    /**
     ...
     * @event
     */
    arcgisSeriesColorChange: EventEmitter<PieSlicesSymbols>;
    /**
     ...
     */
    handleChartOutputDataChange(event: CustomEvent<WebChartGenericDataItem>): void;
    /**
     * Listener on event coming from the chart container indicating the chart data has been fetched
     * emitting an event carrying the data
     * @param {CustomEvent<WebChartDataItem[]>} event The event carrying the chart data
     * @category Custom-event handler
     */
    handleDataFetched(event: CustomEvent<WebChartDataItem[]>): void;
    /**
     ...
     * have been assigned
     * @param {CustomEvent<PieSlicesSymbols>):} event The event carrying the slice symbols
     * @category Custom-event handler
     */
    handleSeriesColorsChange(event: CustomEvent<PieSlicesSymbols>): void;
    /**
     ...
     * @param {boolean} newValue The new value of the prop
     */
