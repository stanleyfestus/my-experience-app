...
gl_Position = vec4(position.xy, 1.0, 1.0);`),p.main.add(d`fragColor = color;`);else{o.include(r,e),o.attributes.add(g.POSITION,"vec3"),o.varyings.add("vtc","vec2"),o.varyings.add("falloff","float");const t=e.geometry===i.Cylinder;l.uniforms.add(new c("proj",((e,o)=>o.camera.projectionMatrix)),new c("view",((e,o)=>o.camera.viewMatrix))),t||(o.varyings.add("innerFactor","float"),l.uniforms.add(new s("silCircleCenter",(e=>e.silhouette.center))),l.uniforms.add(new s("silCircleV1",(e=>e.silhouette.v1))),l.uniforms.add(new s("silCircleV2",(e=>e.silhouette.v2))),l.uniforms.add(new n("texV",(e=>e.texV))),l.uniforms.add(new a("innerScale",(e=>e.innerScale))));const m=6.2831853,u=1/128;l.main.add(d`
	  ...
	  `),p.uniforms.add(new f("tex",(e=>e.texture))),t||p.uniforms.add(new a("altitudeFade",(e=>e.altitudeFade))),p.main.add(d`
			vec4 atmosphereColor = texture(tex, vtc) * falloff;
      ${t?d`fragColor = atmosphereColor;`:d`
			vec4 innerColor = vec4(atmosphereColor.rgb, 1.0 - altitudeFade);
			fragColor = mix(atmosphereColor, innerColor, smoothstep(0.0, 1.0, innerFactor));`}`)}return o}const v=Object.freeze(Object.defineProperty({__proto__:null,SilhouetteCircle:u,SimpleAtmospherePassParameters:p,build:h},Symbol.toStringTag,{value:"Module"}));export{p as S,v as a,u as b,h as c};
