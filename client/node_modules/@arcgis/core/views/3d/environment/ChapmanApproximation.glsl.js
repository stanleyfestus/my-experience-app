...
*/
import{create as e}from"../../../core/libs/gl-matrix-2/factories/vec2f64.js";import{create as t}from"../../../core/libs/gl-matrix-2/factories/vec4f64.js";import{earth as r}from"../../../geometry/support/Ellipsoid.js";import{Float2PassUniform as a}from"../webgl-engine/core/shaderModules/Float2PassUniform.js";import{Float4PassUniform as s}from"../webgl-engine/core/shaderModules/Float4PassUniform.js";import{NoParameters as i,glsl as o}from"../webgl-engine/core/shaderModules/interfaces.js";class c extends i{constructor(){super(...arguments),this.radii=e(),this.heightParameters=t()}}function n(e){e.uniforms.add(new a("radii",(e=>e.radii)),new s("heightParameters",(e=>e.heightParameters))),e.constants.add("scaleHeight","float",r.scaleHeight*r.atmosphereHeight),e.code.add(o`float chapmanApproximation(float thickness, float height, float cosZenith) {
...
}`),e.code.add(o`float getOpticalDepth(vec3 position, vec3 dir, float h) {
return scaleHeight * chapmanApproximation(radii[0] / scaleHeight, h, dot(normalize(position), dir));
}`),e.code.add(o`vec4 planetIntersect(vec3 cameraPos, vec3 rayDir) {
