...
const useWebScene = index$1.makeAccessorController(index$3.newWebScene);
const useSceneView = index$1.makeAccessorController(index$3.newViewsSceneView);
const ArcgisScene = class {
    constructor(hostRef) {
        ...
        this.view = index$1.readonly(useSceneView(this, { editConstructorProperties: this._editViewProperties }));
        ...
        this.camera = index$1.getSet(undefined, {
            get: () => this.view.camera,
            set: (newValue, oldValue) => {
                this.view.camera = componentUtils.isNotSameCamera(oldValue, newValue) ? newValue : oldValue;
        ...
        this.clippingArea = index$1.getSet(this.view.clippingArea, {
            set: (newValue, oldValue) => (oldValue?.equals(newValue) ? oldValue : newValue),
        });
        this.constraints = this.view.constraints;
        this.environment = index$1.getSet(this.view.environment, {
        ...
        this.performanceInfo = index$1.getSet(undefined, {
        ...
        this.resolution = index$1.getSet(undefined, {
    ...
    render() {
        return index.h("div", { key: '3954f72b45b30eabbb33ec2fd96000d72ec862b9', class: "arcgis-scene", ref: this._setChildElement });
    }
