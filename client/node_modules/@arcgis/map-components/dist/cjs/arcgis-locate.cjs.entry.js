...
const useLocateViewModel = useViewModel.makeViewModelController(index$3.newWidgetsLocateLocateViewModel);
const ArcgisLocate = class {
    constructor(hostRef) {
        ...
        this.viewModelLocate = index.createEvent(this, "arcgisSuccess", 7);
        this.viewModelLocateError = index.createEvent(this, "arcgisError", 7);
        //--------------------------------------------------------------------------
        //
        //  Controllers
        //
    ...
    render() {
        ...
        return (index.h("div", { key: '4214efa088483dfb81f0a5f0ff60bea78262b598', class: index$3.classes(css.base, globalCss.globalCss.widget) }, !hidden && (index.h("calcite-button", { key: 'a20435d8dfc4d32ef3f05539f646b6f819261ad2', class: globalCss.globalCss.widgetButton, disabled: state === "disabled", "icon-start": isLoading ? undefined : (icon ?? defaultIcon), kind: "neutral", label: label, onClick: this._locate, title: label }, isLoading ? index.h("calcite-loader", { inline: true, label: "" }) : null)), errorText ? (index.h("calcite-tooltip", { open: true, "overlay-positioning": "fixed", "reference-element": this.el }, errorText)) : null));
    }
