...
const useAreaMeasurement3dWidget = useWidget.makeWidgetController(index$3.newWidgetsAreaMeasurement3D);
const ArcgisAreaMeasurement3d = class {
    constructor(hostRef) {
        ...
        this.arcgisPropertyChange = index$2.usePropertyChange()("analysis", "state");
