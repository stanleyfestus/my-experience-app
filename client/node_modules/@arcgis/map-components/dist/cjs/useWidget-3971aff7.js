...
const index = require('./index-bb8f4b21.js');
...
class WidgetController extends index.AccessorController {
    ...
    async hostLoad() {
        ...
        if (visibleElements.length > 0) {
            this.onLifecycle(() => visibleElements.map(([prop, propertyChain]) => {
                ...
                return index.watch(this.component, prop, (rawVisible) => this._updateWidgetVisibleElement(propertyChain, rawVisible, shouldFlip));
            }));
        }
    }
    ...
    _watchMetaProperties() {
        index.watch(this.component, "position", (position) => {
            if (this.component.el.childElem != null && typeof position === "string") {
                componentUtils.attachToParent(this.component);
            }
        });
        index.watch(this.component, "referenceElement", () => componentUtils.attachToParent(this.component));
    }
    _makeVisibleElementsBinder() {
        return new Proxy({}, {
            ...
            get: (target, prop) => {
                ...
                return index.trackPropKey(this.component, (rawResolvedKey) => {
