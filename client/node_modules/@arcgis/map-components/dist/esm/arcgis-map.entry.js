...
import { u as useControllerManager, r as readonly, g as getSet, a as accessorSupport, m as makeAccessorController } from './index-25757424.js';
import { h as importCoreReactiveUtils, X as newWebMap, Y as newViewsMapView } from './index-c73b2050.js';
import { p as parseCenter, b as isNotSameViewpoint } from './component-utils-5806dcb0.js';
...
const ArcgisMap = class {
    constructor(hostRef) {
        ...
        this.view = readonly(useMapView(this, { editConstructorProperties: this._editViewProperties }));
    ...
    render() {
        return h("div", { key: 'a1234ec352a45db78f83d92985c3bd30ed3ffa16', class: "arcgis-map", ref: this._setChildElement });
    }
