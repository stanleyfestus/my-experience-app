...
async function importLayersOrientedImageryLayer() {
  ...
  const module = await import('@arcgis/core/layers/OrientedImageryLayer.js');
  return isDefaultModule(module) ? module.default : module;
}
...
async function importWidgetsBasemapToggleBasemapToggleViewModel() {
  ...
  const module = await import('@arcgis/core/widgets/BasemapToggle/BasemapToggleViewModel.js');
  return isDefaultModule(module) ? module.default : module;
}
...
async function importWidgetsCatalogLayerList() {
  ...
  const module = await import('@arcgis/core/widgets/CatalogLayerList.js');
  return isDefaultModule(module) ? module.default : module;
}
...
async function importWidgetsCompassCompassViewModel() {
  ...
  const module = await import('@arcgis/core/widgets/Compass/CompassViewModel.js');
  return isDefaultModule(module) ? module.default : module;
}
...
async function importWidgetsFullscreenFullscreenViewModel() {
  ...
  const module = await import('@arcgis/core/widgets/Fullscreen/FullscreenViewModel.js');
  return isDefaultModule(module) ? module.default : module;
}
...
async function importWidgetsLocateLocateViewModel() {
  ...
  const module = await import('@arcgis/core/widgets/Locate/LocateViewModel.js');
  return isDefaultModule(module) ? module.default : module;
}
...
async function importWidgetsScaleBarScaleBarViewModel() {
  ...
  const module = await import('@arcgis/core/widgets/ScaleBar/ScaleBarViewModel.js');
  return isDefaultModule(module) ? module.default : module;
}
...
async function importWidgetsTrackTrackViewModel() {
  ...
  const module = await import('@arcgis/core/widgets/Track/TrackViewModel.js');
  return isDefaultModule(module) ? module.default : module;
}
...
async function importWidgetsZoomZoomViewModel() {
  ...
  const module = await import('@arcgis/core/widgets/Zoom/ZoomViewModel.js');
  return isDefaultModule(module) ? module.default : module;
}
...
export { newWidgetsOrientedImageryViewer as $, newLayersRouteLayer as A, newWidgetsDirections as B, newWidgetsDirectLineMeasurement3D as C, Deferred as D, newWidgetsDistanceMeasurement2D as E, newWidgetsEditor as F, newWidgetsElevationProfile as G, newWidgetsExpand as H, newWidgetsFeature as I, newWidgetsFeatureForm as J, newWidgetsFeatureTable as K, newLayersFeatureLayer as L, newWidgetsFeatureTemplates as M, newWidgetsFeatures as N, newWidgetsFloorFilter as O, newWidgetsFullscreenFullscreenViewModel as P, newWidgetsHistogram as Q, newWidgetsHistogramRangeSlider as R, newWidgetsHomeHomeViewModel as S, newWidgetsLayerList as T, newWidgetsLegend as U, newWidgetsLineOfSight as V, newWidgetsLocateLocateViewModel as W, newWebMap as X, newViewsMapView as Y, newWidgetsMeasurement as Z, newWidgetsNavigationToggle as _, safeCall as a, newLayersOrientedImageryLayer as a0, newWidgetsPrint as a1, importIntl as a2, importApplicationsComponentsGetDefaultUnits as a3, newWidgetsScaleBarScaleBarViewModel as a4, newWidgetsScaleRangeSlider as a5, newWebScene as a6, newViewsSceneView as a7, newWidgetsShadowCast as a8, newLayersGraphicsLayer as a9, newWidgetsSketch as aa, newWidgetsSlice as ab, newWidgetsSlider as ac, newWidgetsSwipe as ad, newWidgetsTableList as ae, newWidgetsTimeSlider as af, newWidgetsTrackTrackViewModel as ag, newWidgetsUtilityNetworkAssociations as ah, newWidgetsUtilityNetworkTrace as ai, newWidgetsUtilityNetworkValidateTopology as aj, newWidgetsValuePicker as ak, newWidgetsVersionManagementVersionManagementViewModel as al, newWidgetsWeather as am, newWidgetsZoomZoomViewModel as an, safeAsyncCall as b, importCoreAccessor as c, devToolsAwareTimeout as d, importCoreAccessorSupportDecorators as e, camelToKebab as f, getElementLocales as g, importCoreReactiveUtils as h, isNotUndefined as i, newWidgetsAreaMeasurement2D as j, newWidgetsAreaMeasurement3D as k, newWidgetsAttachments as l, newWidgetsBasemapGallery as m, newWidgetsSearch as n, newWidgetsBasemapLayerList as o, importApplicationsComponentsBasemapUtils as p, classes as q, newWidgetsBasemapToggleBasemapToggleViewModel as r, startLocaleObserver as s, newWidgetsBookmarks as t, newWidgetsBuildingExplorer as u, newWidgetsCatalogLayerList as v, newWidgetsCompassCompassViewModel as w, newWidgetsCoordinateConversion as x, newWidgetsDaylight as y, newWidgetsDirectionalPad as z };
