...
const ArcgisVersionManagementServiceItem = class {
    ...
    render() {
        ...
        const comboboxVersions = (h("calcite-combobox", { key: '55e20d6e5f51b908ad71384612d1832aa6b1bf31', clearDisabled: true, label: serviceName, maxItems: 5, overlayPositioning: "fixed", selectionMode: "single-persist", onCalciteComboboxChange: (event) => {
        ...
        if (allowEditing) {
            actionManageVersions = (h("calcite-action", { key: '5d130fb6308283a8405d5d786ccc5deed2a65b1d', id: `actionManageVersions_${serviceName}`, icon: "list", scale: "s", slot: "control", text: "", onClick: async () => {
            ...
            tooltipManageVersions = (h("calcite-tooltip", { key: '522b0802ecd431e4f9a1069e20f65c3256fb6e0c', overlayPositioning: "fixed", referenceElement: `actionManageVersions_${serviceName}` }, h("span", { key: '15b78ec25223344535c237f5cd35f39c19007fa3' }, strings.headers.manageVersions)));
        }
        return (h("calcite-block", { key: 'ce0894bbfcadf673e7a72fc51d3fc73caa383189', open: true, heading: serviceName }, comboboxVersions, actionManageVersions, tooltipManageVersions));
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
