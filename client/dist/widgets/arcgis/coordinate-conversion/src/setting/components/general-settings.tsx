...
interface State {
  apiLoaded: boolean
  zoomScaleInput: number
  isPanelOpened: boolean
  defaultSymbol: __esri.SimpleMarkerSymbol | __esri.PictureMarkerSymbol | __esri.PointSymbol3D
}
      ...
      <div css={getGeneralSettingsStyle(this.props.theme)}>
        ...
        <SettingRow label={this.nls('zoomScale')}>
          ...
          <NumericInput aria-label={this.nls('zoomScale')} size={'sm'} className={'zoomScaleInput'}
            defaultValue={this.state.zoomScaleInput} showHandlers={false} onChange={this.onZoomScaleInputChange} />
        </SettingRow>
      </div>
    </div>
  }
