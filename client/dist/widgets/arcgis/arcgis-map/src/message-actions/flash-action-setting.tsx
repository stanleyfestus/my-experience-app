...
import { ChooseConnectionType } from 'jimu-for-builder'
      ...
      <div css={this.getStyle(this.props.theme)}>
        ...
        {/* Conditions */}
        {
          ...
          <SettingSection title={this.props.intl.formatMessage({ id: 'mapAction_Conditions', defaultMessage: defaultMessages.mapAction_Conditions })} className='pt-5'>
            <SettingRow label={this.props.intl.formatMessage({ id: 'mapAction_RelateMessage', defaultMessage: defaultMessages.mapAction_RelateMessage })} className='mt-2'>
