...
import {
  ...
  classNames, polished, ReactResizeDetector, MutableStoreManager, type IMUrlParameters, type DataSource, ExBAddedJSAPIProperties
} from 'jimu-core'
...
import { checkIsLive, type MapUrlHashParams, isFullscreenEnabled, getFullscreenElement, requestFullscreen, exitFullscreen } from './utils'
import {
