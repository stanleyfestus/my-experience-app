  ...
  render () {
    ...
    return (
      <div css={this.getCSSStyle()}>
        ...
        {this.state.sketchInitialed && <div onClick={this.toggleSelectTypePopup} title={moreIconTitle} style={{}} className={classNames('exbmap-ui-tool border-0 esri-widget--button')}
