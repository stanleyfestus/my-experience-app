...
import { getJimuMapViewId, updateUrlHashParamsForActiveJimuMapView } from '../utils'
...
interface State {
  ...
  // this.refs.firstMapInstance always binds to firstMapDsId and refs.secondMapInstance always binds to secondMapDsId
...
export default class MultiSourceMap extends React.PureComponent<Props, State> {
  ...
  onResize = (width, height) => {
    ...
    // 1. Map widget is placed at Column widegt.
