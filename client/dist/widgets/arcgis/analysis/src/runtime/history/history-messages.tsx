...
import { type LocaleItem, type AnalysisEngine } from '@arcgis/analysis-ui-schema'
...
import { ZeroCreditTools } from '@arcgis/analysis-core'
...
const HistoryMessages = (props: Props) => {
  ...
  const needDisplayMessages = useMemo(() => {
    ...
    return messages
  }, [translate, startTimeStamp, displayedMessages, errorAndWarningMessages.length, jobStatus, endTimeStamp, getCreditMessageInfo, getMessageLabel, getFormattedMessage, translatedToolName])
