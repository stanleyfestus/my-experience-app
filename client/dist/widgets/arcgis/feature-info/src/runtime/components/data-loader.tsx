...
export class DataLoader extends React.PureComponent<Props, State> {
  ...
  async componentDidUpdate (prevProps, prevState) {
    ...
    if (dataSourceQueryWhereChanged || fromObjectIdModeToIndexMode || fromNoCountInfoModeToNeedCountInfoMode) {
  ...
  getCurrentDataByObjectId = async (objectId) => {
  ...
  async queryGraphicByObjectId (objectId) {
  ...
  async queryGraphicByIndex (indexParam) {
