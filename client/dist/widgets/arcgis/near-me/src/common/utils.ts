import { type DataSource, DataSourceManager, Immutable, DataSourceTypes, type ImmutableObject, getAppStore, loadArcGISJSAPIModule, type IMDataSourceSchema } from 'jimu-core'
import { MapViewManager } from 'jimu-arcgis'
import { type SearchSettings, type ColorMatches, type ColorMatchUpdate, type LayersInfo, AnalysisTypeName } from '../config'
 ...
 */
export const getUseDataSourcesForAllDs = (config) => {
    ...
    layersInfo?.forEach((configLayer) => {
      ...
      const useDs = alreadyUsedDs?.length > 0
        ...
        : {
            ...
            mainDataSourceId: configLayer.useDataSource.dataSourceId,
