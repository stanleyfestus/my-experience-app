          ...
          {!searchCurrentExtent && showSketchTools &&
            <div className='w-100 d-flex locate-incident-section'>
              ...
              {(sketchTools?.showPoint) &&
                <Button type='tertiary' className='action-button' icon aria-label={this.nls('point')} title={this.nls('point')}
              ...
              {(sketchTools?.showPolyline) &&
                <Button type='tertiary' className='action-button' icon aria-label={this.nls('polyline')} title={this.nls('polyline')}
              ...
              {(sketchTools?.showPolygon) &&
                <Button type='tertiary' className='action-button' icon aria-label={this.nls('polygon')} title={this.nls('polygon')}
