...
import { Button, MultiSelect, type MultiSelectItem, Label, Checkbox } from 'jimu-ui'
...
export function QueryItemSettingDataMode (props: Props) {
  ...
  const handleSpatialRelationsChange = hooks.useEventCallback((evt, value, values) => {
        ...
        <SettingSection>
          <SettingRow flow='wrap' label={getI18nMessage('chooseSpatialRelationshipRules')}>
            <MultiSelect
              ...
              fluid
              onClickItem={handleSpatialRelationsChange}
