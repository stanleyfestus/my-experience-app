            ...
            <div className={'track-content'} css={this.widgetStyle}>
                <div className='track-head'>
                    ...
                    <Tooltip title={visibleTitle} placement='bottom'>
                        <Button className='ml-auto' icon size='sm' type='tertiary' onClick={() => { this.props.handleLayerVisibleChange([this.props.dataSourceId], !this.props.layerVisible, 1) }} aria-label={visibleTitle}>
