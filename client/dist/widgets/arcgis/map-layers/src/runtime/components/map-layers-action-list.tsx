...
import { type MapDataSource, type JimuMapView } from 'jimu-arcgis'
...
export default function MapLayersActionList (props: ActionListProps) {
  const { widgetId, actionObjects, listItem, onActionListItemClick, jimuMapView, shouldHideEmptyList, enableDataAction = true, mapDataSource } = props
  ...
  }, [enableDataAction, listItem.layer, onActionListItemClick, shouldHideEmptyList, widgetId, jimuMapView, mapDataSource])
