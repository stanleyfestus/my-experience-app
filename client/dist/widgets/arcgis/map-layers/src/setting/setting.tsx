    ...
    if (this.state.useMapWidget) {
      ...
      actionsContent = (
        <React.Fragment>
         <SettingRow label={this.getFormattedMessage('goto')} >
          ...
          <SettingRow label={this.getFormattedMessage('popup')} >
            <Switch
              className="can-x-switch"
              checked={
                (this.props.config && this.props.config.popup) || false
              }
              data-key="popup"
              onChange={(evt) => {
                this.onOptionsChanged(evt.target.checked, 'popup')
              }}
              aria-label={this.getTranslatedString('popup')}
            />
          </SettingRow>
      ...
      optionsContent = (
        <React.Fragment>
          ...
          {/* <SettingRow label={this.getFormattedMessage('showTables')} >
            <Switch
              className="can-x-switch"
              checked={
                (this.props.config && this.props.config.showTables) || false
              }
              data-key="showTables"
              onChange={(evt) => {
                this.onOptionsChanged(evt.target.checked, 'showTables')
              }}
              aria-label={this.getTranslatedString('showTables')}
            />
          </SettingRow> */}
        </React.Fragment>
      )
