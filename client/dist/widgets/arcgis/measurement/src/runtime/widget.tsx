/** @jsx jsx */
import { React, jsx, type AllWidgetProps, hooks, css, classNames, AppMode, type IMState, ReactRedux, WidgetState, appActions, getAppStore } from 'jimu-core'
  ...
  return <div id={id} className='widget-measurement h-100 surface-1 border-0' css={style}>
    {!ready &&
      <div className='w-100 h-100'>
        <WidgetPlaceholder className='w-100 placeholder-wrapper'
