...
import { type WroModel, type WroStatus, type ModelController } from './wro-model'
...
export class ChartPanel extends React.PureComponent<any, State> {
  ...
  watchImageLayer (): void {
    ...
    if (imageLayer && typeof imageLayer.watch === 'function') {
      ...
      this.imageLayerHandle = imageLayer.watch('rasterFunction', (newVal, oldVal, property, object): any => {
