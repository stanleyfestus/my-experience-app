          ...
          hasMap
            ? <div>
                ...
                {(swipeStyle === SwipeStyle.SimpleHorizontal || swipeStyle === SwipeStyle.SimpleVertical) &&
                  ...
                  <SettingRow label={translate('defaultActivation')}>
                    <Switch
                      aria-label={translate('defaultActivation')}
                  ...
                  <SettingRow label={translate('toggleLayerVisibility')}>
                    <Switch
                      aria-label={translate('toggleLayerVisibility')}
