...
import { ArcGISDataSourceTypes, type JimuMapView, loadArcGISJSAPIModules, MapViewManager, type FeatureLayerDataSource } from 'jimu-arcgis'
  ...
  componentDidMount = () => {
    if (!this.state.apiLoaded) {
      loadArcGISJSAPIModules([
        ...
        this.setState({
          apiLoaded: true,
          bufferSymbol: this.props.config.assetIntersectingBuffer?.bufferSymbol ? this._jsonUtils.fromJSON(this.props.config.assetIntersectingBuffer?.bufferSymbol) : this._jsonUtils.fromJSON(defaultBufferSymbol)
        }, () => {
