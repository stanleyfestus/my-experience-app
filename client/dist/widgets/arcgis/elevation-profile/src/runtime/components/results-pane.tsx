/** @jsx jsx */
import { React, jsx, type IntlShape, type IMThemeVariables, classNames, Immutable, getAppStore, lodash, type DataSource, DataSourceManager } from 'jimu-core'
import {
...
export default class ResultPane extends React.PureComponent<Props, IState> {
  ...
  componentDidMount = () => {
    ...
    if (this.props.selectMode || this.props.drawMode) {
      setTimeout(() => {
        this._alertElement?.current?.focus()
      }, 100)
    }
  }
  ...
  statisticsDisplay = () => {
    return (<div>
      {this.props.isMobile
        ...
        : <Popper css={getChartStyle(this.props.theme)}
