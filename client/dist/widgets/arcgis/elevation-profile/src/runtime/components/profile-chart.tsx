...
import { type ProfileLayersSettings, type LayerIntersectionInfo, type GeneralSetting, type ElevationLayersInfo, type ProfileStyle } from '../../config'
            ...
            this.createDataForIntersectingAssets(allElevations).then(() => {
              ...
              this.setState({
                ...
                if (this._chart) {
                  ...
                  this._accessChartParams.chart.zoomOutButton.get('background').set('fill', colorAm5(this.props.theme.sys.color.primary.main))
