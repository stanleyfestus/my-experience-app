...
export const MapSettings = React.memo((props: Props) => {
  ...
  return (
    <SettingSection title={translate('mapSettings')} aria-label={translate('mapSettings')} >
    {isMapContainWebScene(props.useMapWidgetIds) && <React.Fragment>
      {/* 1. title */}
      <SettingRow label={translate('mapSettingsTip')} className='mapSettingsTip' css={getStyle(theme)}></SettingRow>
      {/* 2. map setting list */}
      <SettingRow className='d-block'>
        <div className='w-100'>
          <MultipleJimuMapConfig
            ...
            sidePopperContent={
              ...
              <SettingSection>
                ...
                <SettingRow label={translate('layerOnLoading')}></SettingRow>
              ...
              <SettingSection>
                <SettingRow label={translate('disciplinesCategories')}>
                  <Switch aria-label={translate('disciplinesCategories')}
