...
import { type IMConfig, type MapsSettings, type NumericRange, type ViewModelResult } from '../../../config'
...
export const PhaseSetting = React.memo((props: Props) => {
  ...
  return (
    <SettingSection>
      {/* 3.1 */}
      <SettingRow label={translate('buildingPhase')}>
        <Switch aria-label={translate('buildingPhase')}
