...
import { type NumericRange, type ViewModelResult } from '../../config'
...
export const CalculateForSetting = React.memo((props: Props) => {
  ...
  if (view?.map) {
    ...
    webSceneForSetting.when(() => {
      function getBuildingLayers (allLayers: __esri.Collection<__esri.Layer>): __esri.Collection<__esri.BuildingSceneLayer> {
