...
export function getStyle (theme: IMThemeVariables, config: IMConfig, id: string, appMode: AppMode, widgetRect: ElementSize, configBookmarkNum: number, runtimeBookmarkNum: number, isWebMap: boolean): SerializedStyles {
    ...
    ${'&.bookmark-widget-' + id} {
      ...
      .bookmark-container {
        ...
        .bookmark-card-title, .bookmark-card-title input {
          ...
          text-decoration: ${config.cardNameStyle.fontStyles?.decoration};
        ...
        .bookmark-slide {
          position: absolute;
          bottom: ${
            config.templateType === TemplateType.Slide3 ? '0px' : 'unset'
          };
          opacity: 0.8;
          background: ${theme.ref.palette.white};
          ${cardBackgroundStyle}
          ...
          .bookmark-slide-title {
            ...
            text-decoration: ${config.slidesNameStyle.fontStyles?.decoration};
          ...
          .bookmark-slide-description {
            ...
            text-decoration: ${config.slidesDescriptionStyle.fontStyles?.decoration};
