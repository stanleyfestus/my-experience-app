...
import { Button, Card, CardBody, ImageWithParam, TextInput } from 'jimu-ui'
      ...
      return (
        <div className='gallery-card' key={index} css={cardStyle}>
          <Card
            ...
            className={classNames('gallery-card-inner surface-1 h-100 bookmark-pointer', { 'active-bookmark-item': isBookmarkItemActive })}
          >
      ...
      return (
        <div className='gallery-card' key={`RuntimeGallery-${rbmId}`} css={cardStyle}>
          <Card
            ...
            className={classNames('gallery-card-inner h-100 surface-1 runtime-bookmark bookmark-pointer bookmark-pointer', { 'active-bookmark-item': isBookmarkItemActive })}
            role='listitem'
            aria-selected={isBookmarkItemActive}
            tabIndex='0'
