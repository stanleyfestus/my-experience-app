...
export function getGalleryStyle (theme: IMThemeVariables, direction: DirectionType, galleryItemWidth: number, galleryItemHeight: number, galleryItemSpace: number, cardBackground: string, displayName: boolean, isWebMap: boolean, itemSizeType: ItemSizeType, widgetRect): SerializedStyles {
