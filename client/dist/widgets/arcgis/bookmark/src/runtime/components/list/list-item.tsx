...
import { type Bookmark, type IMConfig } from '../../../config'
    ...
    {bookmarks.map((item, index) => {
      ...
      return (
        <div
          ...
          className={classNames('d-flex bookmark-list-col surface-1 bookmark-pointer', { 'active-bookmark-item': isBookmarkItemActive })}
          role='listitem'
    ...
    {runtimeBookmarkArray.map((rbmId, index) => {
      ...
      return (
        <div
          ...
          className={classNames('d-flex runtime-bookmark runtime-bookmarkList surface-1 bookmark-pointer', { 'active-bookmark-item': isBookmarkItemActive })}
        >
          {!hideIcon && <PinOutlined className='ml-4 bookmark-list-icon' />}
          <TextInput
