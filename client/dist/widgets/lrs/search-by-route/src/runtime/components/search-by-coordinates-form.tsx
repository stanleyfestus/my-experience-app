...
import { type CoordinateQuery, type NetworkItem, Coordinate, SpatialReferenceFrom } from '../../config'
import { useImperativeHandle } from 'react'
import type GraphicsLayer from 'esri/layers/GraphicsLayer'
import { coordinateGraphicColor } from '../../constants'
...
export const SearchCoordinatesForm = React.forwardRef((props: SearchCoordinatesProps, ref) => {
  const { reset, isDataSourceReady, onSubmit, networkItem, onValidationChanged, coordinateGraphic } = props
    ...
    <div className='search-by-coordinates-form' css={getFormStyle()}>
      <div className='search-by-coordinates-form__content my-2'>
        <div className="search-by-coordinates-form__x-coordinate-label pt-2 px-3">
          <Label size="default" className='mb-1' style={{ width: '100%' }} >
