/** @jsx jsx */
import { React, jsx, css, type FeatureLayerDataSource, type DataRecord, type FeatureDataRecord, type ImmutableObject, type IntlShape } from 'jimu-core'
...
export function SearchByRouteResultList (props: ResultsListProps) {
  ...
  const loadByPages = React.useCallback(async (currentPage: number, pageSize: number) => {
