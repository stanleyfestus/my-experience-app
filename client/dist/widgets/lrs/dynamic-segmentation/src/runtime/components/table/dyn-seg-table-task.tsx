...
import { type RouteInfoFromDataAction, type AttributeSetParam, type SubtypeLayers } from '../../../config'
...
export function DynSegTableTask (props: DynSegTableTaskProps) {
  const { intl, conflictPreventionEnabled, routeId, networkDS, featureLayer, records, lrsLayers, attributeSet, networkInfo, currentRouteInfo, handleLockToast } = props
