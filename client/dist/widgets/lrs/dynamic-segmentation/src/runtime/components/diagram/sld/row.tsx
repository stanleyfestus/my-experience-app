...
import { type MeasureRange, type Track, type DynSegFieldInfo, type SubtypeLayers, type TrackRecord } from '../../../../config'
...
export function Row (props: RowProps) {
  const { allLayersDS, trackMap, contentWidth, measureRange, isActive, featureLayer, subtypeLayers, onItemClick, onItemHover, onItemHoverExit } = props
