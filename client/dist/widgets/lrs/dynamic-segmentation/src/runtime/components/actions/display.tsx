...
export function Display () {
  ...
  return (
    <CalciteActionGroup scale='m'>
      <Tooltip
        placement='auto'
        title={isDisabled(DisplayType.Table) ? getI18nMessage('tableLabelDisabled') : getI18nMessage('tableLabel')}
        showArrow
        enterDelay={300}
        enterNextDelay={1000}>
        <CalciteAction
      ...
      <Tooltip
        placement='auto'
        title={isDisabled(DisplayType.Diagram) ? getI18nMessage('diagramLabelDisabled') : getI18nMessage('diagramLabel')}
        showArrow
        enterDelay={300}
        enterNextDelay={1000}>
        <CalciteAction
