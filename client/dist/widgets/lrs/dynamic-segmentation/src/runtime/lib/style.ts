...
export function getStyle (theme: IMThemeVariables, tableHighlightColor: string): SerializedStyles {
  return css`
    ...
    .dyn-seg-cell.edited {
      --calcite-table-cell-background: ${polished.rgba(theme.sys.color.warning.light, 0.4)};
    }
    .dyn-seg-cell.non-editable {
      --calcite-table-cell-background: ${polished.rgba(theme.sys.color.action.disabled.default, 0.2)};
    }
    .dyn-seg-cell.error {
      --calcite-table-cell-background: ${polished.rgba(theme.sys.color.error.main, 0.2)};
    }
    ...
    .header-divider::hover {
      border-left: 1px solid ${polished.rgba(theme.sys.color.secondary.light, 0.3)};
      height: 100%;
    }
    .toast-container {
      position: absolute;
    ...
    .sidebar-resizer:hover {
      border-left: 5px solid ${polished.rgba(theme.sys.color.divider.input, 0.5)};
      border-right: 5px solid ${polished.rgba(theme.sys.color.divider.input, 0.5)};
      cursor: col-resize;
      }
    .header {
      height: ${SLD_TRACK_HEIGHT}px;
