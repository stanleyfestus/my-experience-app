...
import { Alert, Button, Label, Select, Tooltip } from 'jimu-ui'
    ...
    <div className="split-event h-100 d-flex" css={getFormStyle()}>
      ...
      <div className="split-event__content">
        ...
        <div className='d-flex w-100 px-3'>
          <Label size="sm" className='d-flex mb-0 w-100' style={{ width: 100, alignItems: 'center' }}>
              {eventOid}
          </Label>
        </div>
      ...
      <div className='split-event-footer w-100'>
        <div className='split-event-footer__action w-100 d-flex'>
          <Label
            ...
            style={{ fontWeight: 500, marginBottom: 0, alignItems: 'center', textAlign: 'left', color: 'var(--primary-500)' }}
            onClick={handleReset}
          >
            Reset
          </Label>
