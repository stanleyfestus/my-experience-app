...
function _HeaderSetting (props: HeaderConfig & { widgetId: string }) {
    ...
    <div className='w-100'>
      <div className='header-setting w-100 mt-2' css={style} ref={ref}>
        <Tooltip title={translate('bgAndBorder')}>
          <div className={classNames('border-setting with-bg', { active: activePart === 'border' })} onClick={() => { setActivePart('border') }}></div>
        </Tooltip>
        <Tooltip title={translate('padding')}>
          <div className={classNames('padding-setting with-bg', { active: activePart === 'padding' })} onClick={() => { setActivePart('padding') }}></div>
        </Tooltip>
        <Tooltip title={translate('content')}>
          <div className={classNames('content-setting with-bg d-flex justify-content-center align-items-center', { active: activePart === 'content' })} onClick={() => { setActivePart('content') }}>
      ...
      {activePart === 'content' && (
        <React.Fragment>
          <SettingRow label={translate('icon')} className='mt-4'>
            <Switch
...
export default withTheme(_HeaderSetting)
