...
export default class Widget extends React.PureComponent<AllWidgetProps<IMConfig> & ExtraProps, State> {
  ...
  render () {
    ...
    const header508Id = 'share-header-' + this.props.id
    ...
    return (
      <div css={getStyle(this.props.theme)} data-testid='share-widget' className={this.state.isControllerOffPanelStyle ? 'px-3 py-3' : ''}>
        <React.Fragment>
          {/* 1.popup mode */}
        ...
        <Popper
          ...
          modifiers={this.POPPER_POSITION_CONFIGS} data-testid='mainPopper'
          ...
          keepMount={true}
          aria-labelledby={isShowHeader ? header508Id : null}
        >
