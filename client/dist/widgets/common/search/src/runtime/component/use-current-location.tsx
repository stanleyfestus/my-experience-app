...
const CurrentLocation = (props: CurrentLocationProps) => {
  ...
  return (
    <div>
      {!isGetLocationError && <Button className='text-left d-block' role='button' onClick={confirmUseCurrentLocation} title={nls('useCurrentLocation')}>
        <PinOutlined className='mr-2'/>
        {nls('useCurrentLocation')}
      </Button>}
      {isGetLocationError && <Button className='text-left d-block' role='button' title={nls('couldNotRetrieve')}>
