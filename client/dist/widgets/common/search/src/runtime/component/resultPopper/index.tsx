...
import { React, jsx, classNames, ReactRedux, type IMState, WidgetState, hooks, lodash } from 'jimu-core'
...
const ResultPopper = (props: Props) => {
  ...
  const { children, isOpen, reference, searchInputRef, autoFocus, className, isFocusWithSearchInput, id, offset, version, toggle } = props
