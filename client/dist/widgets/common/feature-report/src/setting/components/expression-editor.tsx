/** @jsx jsx */
import { React, jsx, css, type IMThemeVariables, type SerializedStyles } from 'jimu-core'
    ...
    <div className='w-100 h-100' css={getStyle(theme)}>
      <div className='expression-builder-trigger' ref={curRef}>
        ...
        <FieldSelector
          ...
          dropdownProps={{ size: 'sm', buttonProps: { icon: true } }}
        ...
        />
          <div className='expression-input'>
            <TextInput
              ...
              onChange={onInputChange} onBlur={onInputBlur} title={inputValue}
            />
          </div>
        </div>
    </div>
