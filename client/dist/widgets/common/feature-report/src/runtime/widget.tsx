/** @jsx jsx */
import {
  React, DataSourceManager, type IMDataSourceInfo, type IMUrlParameters, type IMState,
...
export default class Widget extends React.PureComponent<AllWidgetProps<IMConfig>, State> {
  ...
  render () {
     ...
     */
    if (!useDataSource || !config.surveyItemId || !this.state?.featureLayerUrl) {
      content = <div className='widget-featureReport'>
        <WidgetPlaceholder icon={featureReportInfo} message={this.props.intl.formatMessage({ id: '_widgetLabel', defaultMessage: defaultMessages._widgetLabel })} widgetId={this.props.id} />
      </div>
    } else {
      this.updateReportParams()
      content = (
