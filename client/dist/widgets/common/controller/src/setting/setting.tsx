/** @jsx jsx */
import { React, css, jsx, polished, type IMState, Immutable, type ImmutableArray, ReactRedux, type IMThemeButtonStylesByState, hooks, BrowserSizeMode } from 'jimu-core'
    ...
    <div className='widget-setting-controller jimu-widget-setting' css={style}>
      ...
      <SettingSection>
        <CollapsablePanel
          ...
          {!isExpressMode && <SettingRow label={translate('showIconLabel')}>
            <Switch
              checked={showLabel}
          ...
          <SettingRow label={translate('indicator')} className='mt-4'>
            <Switch
              checked={showIndicator}
              aria-label={translate('indicator')}
              onChange={(evt) => {
                onSettingConfigChange(
          ...
          {!isExpressMode && <SettingRow flow='no-wrap' label={translate('iconSizeOverride')}>
            <Select
              size='sm'
          ...
          <SettingRow flow='wrap' label={translate('overflownStyle')}>
            <Select
              size='sm'
