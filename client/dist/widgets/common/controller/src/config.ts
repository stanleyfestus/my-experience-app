import { type ImmutableArray, type ImmutableObject, type Size, type UseDataSource, type ThemeBoxStyles } from 'jimu-core'
import { type ButtonProps, type BoxShadowStyle } from 'jimu-ui'
...
export interface AvatarProps extends Pick<ButtonProps, 'type' | 'size'> {
