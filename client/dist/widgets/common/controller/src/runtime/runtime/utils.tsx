/**@jsx jsx */
import { React, jsx, appActions, getAppStore, hooks } from 'jimu-core'
...
export const getMoreButtonNode = (controllerId: string): HTMLButtonElement => {
  const node = document.querySelector(`[data-widgetid='${controllerId}'] .popup-more-button button`)
  return node as HTMLButtonElement
}
