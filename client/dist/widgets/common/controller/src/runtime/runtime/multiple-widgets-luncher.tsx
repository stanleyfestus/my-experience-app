/** @jsx jsx */
import { React, Immutable, classNames, type IMRuntimeInfos, type IMState, ReactRedux, hooks, jsx, AppMode } from 'jimu-core'
...
export const MultipleWidgetsLuncher = (props: MultipleWidgetsLuncherProps) => {
  const { mode, start, spaceX, spaceY, sizes: propSizes, widgets = DefaultWidgets, layout, onResizeStop, onClick, onClose } = props
