...
import { getSplitByField, SelectionSource, type WebChartDataItem, type SelectionData } from 'jimu-ui/advanced/chart'
...
export const useSelection = (
  ...
  const handleSelectionChange = hooks.useEventCallback((e) => {
    ...
    const selectionItems = getNormalizedSelectionItems(e.detail.selectionItems ?? [], splitByField)
