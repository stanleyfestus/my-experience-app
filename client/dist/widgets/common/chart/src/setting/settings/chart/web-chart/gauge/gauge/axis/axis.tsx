...
export const GaugeAxisSetting = (props: GaugeAxisSettingProps) => {
  ...
  return (<>
    <SettingRow className='mt-2'label={translate('showAxisLabel')} level={3}>
      <Switch aria-label={translate('showAxisLabel')} checked={labelVisible} onChange={handleLabelVisibleChange} />
    </SettingRow>
