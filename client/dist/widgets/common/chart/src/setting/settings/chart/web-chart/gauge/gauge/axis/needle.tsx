...
export const NeedleSetting = (props: NeedleSettingProps) => {
  ...
  return (<>
    {ShowMoreOptions && <SettingRow className='mt-2' label={translate('showNeedlePin')} level={3}>
      <Switch aria-label={translate('showNeedlePin')} checked={displayPin} onChange={handleNeedlePinVisibleChange} />
    </SettingRow>}
    <FillSymbolSetting
      className='mt-2'
