...
import { type ChartComponentOptions, type IWebChart, type WebChartSeries } from '../../../../../config'
...
import { WebChartStackedKinds, type ChartTypes, type WebChartAxis } from 'jimu-ui/advanced/chart'
...
const SerialSetting = (props: SerialSettingProps): React.ReactElement => {
  ...
  const stackedType = propWebChart?.stackedType ?? WebChartStackedKinds.Side
