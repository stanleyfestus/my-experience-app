...
import { getSeriesType, type WebChartLineChartSeries, WebChartStackedKinds } from 'jimu-ui/advanced/chart'
  ...
  return (
    <div className='serial-series-setting w-100' role='group' aria-label={translate('series')}>
      ...
      >
        ...
        >
          <Switch
            aria-label={translate('optimizeLabelDisplay')}
            checked={hideOversizedStackedLabels}
            onChange={handleHideOversizedStackedLabelsChange}
          />
        </SettingRow>}
      </CollapsableToggle>
      <SettingRow label={translate('hoverLabel')} className='mt-3' level={2}>
        <Switch
      ...
      {valuePointerVisibility && <>
        <SettingRow label={translate('valuePoint')} className='mt-3' level={2} >
          <Switch
      ...
      <SettingRow className='mt-3' level={2} label={translate('hideEmptySeries')}>
        <Switch
          checked={options.hideEmptySeries}
          aria-label={translate('hideEmptySeries')}
