/** @jsx jsx */
import { React, hooks, jsx, classNames, css, type AppInfo, Immutable, type ImmutableArray, polished, SessionManager } from 'jimu-core'
import { Dropdown, DropdownButton, DropdownMenu, TextInput, type DropdownButtonProps, DropdownItem, type DropdownMenuProps, type PositioningStrategy, defaultMessages as jimuUiDefaultMessage } from 'jimu-ui'
    ...
    return (
      <div>
        ...
        <div className='dropdown-item-con' ref={ref => { initScroll(ref) }}>
          ...
          {(appItems?.length === 0 && !showLoading) && <DropdownItem disabled>{nls('noItemsFound')}</DropdownItem>}
