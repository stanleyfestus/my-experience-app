...
import { Button, Loading, CollapsablePanel, LoadingType, defaultMessages as jimuiDefaultMessage } from 'jimu-ui'
  ...
  return (
    <SettingSection className={className} css={STYLE} role='group' aria-label={nls('configurePrintTemplate')}>
      ...
      >
        ...
        />
        {showLoading && <div className='loading-con position-relative'><Loading type={LoadingType.Secondary} width={38} height={38}/></div>}
