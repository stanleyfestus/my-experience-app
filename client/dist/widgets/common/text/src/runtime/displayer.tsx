import { React, polished, type IMExpression, ExpressionResolverComponent, expressionUtils } from 'jimu-core'
import { DownDoubleOutlined } from 'jimu-icons/outlined/directional/down-double'
import { styled, useTheme } from 'jimu-theme'
import { RichTextDisplayer, type RichTextDisplayerProps, Scrollable, type ScrollableRefProps, type StyleState } from 'jimu-ui'
