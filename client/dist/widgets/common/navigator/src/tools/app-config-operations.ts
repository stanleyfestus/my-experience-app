import { appConfigUtils, AppMode, getAppStore, i18n, type extensionSpec, type IMAppConfig, defaultMessages } from 'jimu-core'
...
export default class AppConfigOperation implements extensionSpec.AppConfigOperationsExtension {
  ...
  afterWidgetCopied (
    ...
    // if duplicate whole page, will get the copied linkage section id by using: widgetMap?.[config?.data?.section]
