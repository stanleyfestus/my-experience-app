...
import {
  ...
  ImageDisplayQualityMode, AllDataSourceTypes, ExpressionPartType
} from 'jimu-core'
  ...
  render () {
    ...
    const sliderNode = (
      <div className='set-image-display-quality w-100 d-flex flex-wrap align-items-center'>
        ...
        <div className='image-display-quality-option-wrapper hint-default d-flex w-100 justify-content-between' style={{ marginTop: '4px' }}>
