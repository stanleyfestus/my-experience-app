            ...
            {supportAttachment && <div className='w-100 d-flex justify-content-end mt-4' data-testid='dynamicurl-attachment'>
              <div className='w-100'>
                <SettingRow flow='wrap'>
                  ...
                  {this.props.dynamicUrlType === DynamicUrlType.Attachment && <div className='d-flex w-100 justify-content-end mt-4'>
            ...
            {supportSymbol && <div className='w-100 d-flex justify-content-end mt-4'>
              <div className='w-100'>
                <SettingRow flow='wrap'>
                  ...
                  {this.props.dynamicUrlType === DynamicUrlType.Symbol && <div className='d-flex w-100 justify-content-end mt-4'>
                    <MainDataAndViewSelector
                      hideMainDataSourceSelect
                      widgetId={this.props.widgetId}
                      useDataSources={this.props.useDataSources}
