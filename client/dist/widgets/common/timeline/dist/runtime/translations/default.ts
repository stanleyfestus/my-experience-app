export default {
  ...
  noSupportedLayersInMapWidget: 'The map does not contain any time-aware data.',
  invalidTimeSpanWarning: 'Please check the widget configurations to make sure the time span is valid.',
  timezoneWarning: 'The Timeline widget is not available to use under the data time zone.'
}
