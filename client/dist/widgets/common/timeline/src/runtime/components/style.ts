...
export function getTimelineStyles (theme: IMThemeVariables, marginForLR: number, foregroundColor, backgroundColor, sliderColor): SerializedStyles {
  ...
  foregroundColor = getThemeColorValue(foregroundColor || theme.ref.palette.black, theme)
  backgroundColor = backgroundColor || theme.ref.palette.white
  sliderColor = getThemeColorValue(sliderColor || theme.sys.color.primary.main, theme)
