/** @jsx jsx */
import { React, hooks, jsx, css, type AllWidgetProps, type IMState, classNames, DataSourceStatus } from 'jimu-core'
...
const Widget = (props: SelectWidgetProps): React.ReactElement => {
  ...
  // window.dataSourceItemRuntimeInfoMap = dataSourceItemRuntimeInfoMap
