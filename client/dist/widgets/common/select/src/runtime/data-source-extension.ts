import {
  type FeatureLayerDataSource, type SceneLayerDataSource, type FeatureLayerQueryParams, type QueryProgressCallback,
...
export type DataSourceExtensionSourceType = FeatureLayerDataSource | SceneLayerDataSource

/**
 * Wrapper of data source.
 */
export default class DataSourceExtension {
  readonly ds: DataSourceExtensionSourceType
  private readonly widgetId: string

  constructor (ds: DataSourceExtensionSourceType, widgetId: string) {
    this.ds = ds
