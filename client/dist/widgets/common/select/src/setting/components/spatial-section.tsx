...
import { defaultMessages as jimuUIMessages, CollapsablePanel, Collapse, Switch, NumericInput, Select, MultiSelect, type MultiSelectItem } from 'jimu-ui'
...
export default function SpatialSection (props: SpatialSectionProps): React.ReactElement {
  ...
  const imRelationshipItems: ImmutableArray<MultiSelectItem> = React.useMemo(() => {
  ...
  const onRelationshipMultiSelectClickItem = React.useCallback((evt, value, selectedValues: string[]) => {
        ...
        >
          ...
          >
            <MultiSelect
              ...
              items={imRelationshipItems}
              values={imRelationshipValues}
              fluid
              onClickItem={onRelationshipMultiSelectClickItem}
          ...
          >
            <Switch
              aria-label={translate('enableBuffer')}
