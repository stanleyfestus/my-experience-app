...
import { type IconButtonStyles, type IconButtonStylesByState } from '../components/navigation';
...
export declare const toCSSTextUnderLine: (text: Partial<TextFontStyle>) => "none" | "underline" | "line-through" | "underline line-through";
