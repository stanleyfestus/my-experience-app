import { type IMExpressionMap, type Expression, type RepeatedDataSource, type MultipleExpressionResolveResults, type ImmutableObject, type ExpressionPart } from 'jimu-core';
...
export declare const BLANK_CHARATER = "\uFEFF";
export declare const BLAND_SPACE_CHARTER = "\u00A0";
/**
