...
import { type Modifiers, type PositioningStrategy } from './overlay/popper';
/**
 ...
 */
export interface DropdownMenuProps extends Omit<React.HTMLAttributes<HTMLElement>, 'onResize'> {
    /**
