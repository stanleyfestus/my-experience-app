 ...
 * ```
 */
export declare const _Option: React.ForwardRefExoticComponent<Omit<SelectOptionProps, "ref"> & React.RefAttributes<HTMLElement>>;
/**
 * The `Select` component is used to provide the user the ability to choose an option from a list.
 *
 * ```ts
 ...
 * ```
 */
export declare const Option: import("@emotion/styled").StyledComponent<Omit<SelectOptionProps, "ref"> & React.RefAttributes<HTMLElement>, {}, {}>;
