import { type CropParam, type ImageParam } from './index';
import { type Size, ImageDisplayQualityMode, ImageDisplayQualityValue } from 'jimu-core';
export declare function getCroppedImgPositionInWidget(cropParam: CropParam, widgetWidth: number, widgetHeight: number): {
    zoom: number;
    x: number;
    y: number;
};
