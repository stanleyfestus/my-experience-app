...
import { type ModalProps as _ModalProps } from 'reactstrap/lib/Modal';
/**
 ...
 * ```
 */
export declare const _Modal: React.MemoExoticComponent<(props: ModalProps) => React.JSX.Element>;
/**
 * The `Modal` component adds dialogs to your site for lightboxes, user notifications, or completely custom content.
 *
 * ```ts
