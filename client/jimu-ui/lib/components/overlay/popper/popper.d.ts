...
import { type PopperCoreProps } from './core';
import { type TargetType } from './utils';
import { type PopperChildrenProps } from './children';
import { type ArrowStyle } from 'jimu-theme';
export declare const DefaultArrowSize = 12;
/** */
export interface _PopperProps extends Omit<PopperChildrenProps, 'onMouseDown' | 'onDrag' | 'children' | 'openOverlayOnMount'> {
    /**
 ...
 */
export type PopperProps = _PopperProps & Omit<PopperCoreProps, 'reference' | 'children' | 'version'>;
/**
 ...
 * ```
 */
export declare const Popper: import("@emotion/styled").StyledComponent<Omit<_PopperProps & Omit<PopperCoreProps, "children" | "version" | "reference"> & React.RefAttributes<import("@popperjs/core").Instance>, "ref"> & {
    ref?: React.Ref<import("@popperjs/core").Instance>;
}, {}, {}>;
