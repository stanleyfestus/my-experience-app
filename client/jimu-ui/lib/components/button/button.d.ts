...
import { type BrandFunctionColors, type CSSInterpolation } from 'jimu-theme';
import type { ComponentSize } from '../types';
import { type LinkTarget } from '../../types';
export type ButtonSize = 'default' | 'sm' | 'lg';
export type ButtonSlots = 'root' | 'icon';
...
export declare const getButtonStyles: (props: ButtonProps, theme: IMThemeVariables) => CSSInterpolation;
/**
