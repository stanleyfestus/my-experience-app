...
import { type ComponentSize, type StandardComponentProps } from '../types';
import { type PaginationButtonType, type PaginationShape, type PaginationVariant, type PaginationType } from './type';
export type PaginationSlots = 'root' | 'page-list' | 'page-select' | 'page-jumper';
/**
