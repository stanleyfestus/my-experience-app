...
import { type StandardComponentProps, type ComponentSize } from '../types';
import { type PaginationVariant, type PaginationShape, type PaginationButtonType } from './type';
/**
