import { type SceneLayerDataSource, type FeatureLayerDataSource, type IMFieldSchema, type UseDataSource, type IMWidgetJson, JimuFieldType, type ImmutableArray, type DataSourceSchema, type DataSourceJson, type FieldSchema } from 'jimu-core';
...
export declare const getNewDsConfigItem: (options: GetNewDataSourceConfigOptions) => {
    configId: string;
    icon: any;
    label: string;
