/** @jsx jsx */
import { React, type IMAppConfig, LinkType, Immutable, type ImmutableArray, jsx, type IMThemeVariables, type UseDataSource, type BrowserSizeMode, ReactRedux, type IntlShape } from 'jimu-core';
import { type IMLinkParam, OpenTypes, type LinkParam } from '../../types';
/**
...
export declare const LinkSelectorContent: ReactRedux.ConnectedComponent<React.FC<import("react-intl").WithIntlProps<LinkSelectorContentProps>> & {
    ...
    linkParam?: Immutable.ImmutableObjectMixin<LinkParam> & {
        ...
        readonly openType?: import("jimu-ui").LinkTarget;
