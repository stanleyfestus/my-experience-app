import { type ExpressionPart, ExpressionPartType, type ImmutableArray, type UseDataSource, type BrowserSizeMode } from 'jimu-core';
import { type EditResult, type PopoverItem } from '../types';
 ...
 *
 */
export declare function handleOperatorExps(e: string[]): string[];
/**
 *
