import { type DataSource, React, type ImmutableArray, type IntlShape, type ImmutableObject, type DataSourceJson, type UseDataSource, type IMDataSourceJson, type AllDataSourceTypes } from 'jimu-core';
...
export default class DataSourceAddedData extends React.PureComponent<Props, State> {
    ...
    isValidInProps: (ds: DataSource, fromDsIds: ImmutableArray<string>, hideDs: (dsJson: IMDataSourceJson) => boolean, searchValue: string) => boolean;
    isValidInMode: (ds: DataSource) => boolean;
