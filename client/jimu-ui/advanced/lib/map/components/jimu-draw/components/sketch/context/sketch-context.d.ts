...
import { type JimuDrawCreatedDescriptor, type CreateToolActions, type SelectToolActions } from '../sketch-adapter';
import { type LayerListMode, type JimuDrawVisibleElements } from '../constraints';
...
export interface SketchContextStates {
    ...
    activeTool: CreateToolActions | SelectToolActions;
