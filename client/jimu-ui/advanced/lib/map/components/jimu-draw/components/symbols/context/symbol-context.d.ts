...
import { type JimuSymbol, type JimuSymbolType, type JimuPointSymbol, type JimuPolylineSymbol, type JimuPolygonSymbol, type JimuTextSymbol } from 'jimu-ui/advanced/map';
