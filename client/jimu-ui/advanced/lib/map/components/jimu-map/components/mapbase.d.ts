import { React, DataSourceManager, ExtentChangeMessage, type ImmutableObject } from 'jimu-core';
import { type IMJimuMapConfig, type InitialMapState } from '../config';
import { type MapDataSource } from 'jimu-arcgis/arcgis-data-source';
