...
import type { IMLinkParam, LinkSelectorSidePopperProps } from 'jimu-ui/advanced/setting-components';
export interface LinkSettingProps extends Pick<LinkSelectorSidePopperProps, 'hiddenLinks' | 'position' | 'title'> {
    /**
