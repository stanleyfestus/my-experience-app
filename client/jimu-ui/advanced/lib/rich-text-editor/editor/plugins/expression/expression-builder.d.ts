...
import { type ExpressionBuilderProps, ExpressionBuilderType } from 'jimu-ui/advanced/expression-builder';
/**
 * The `RichExpressionBuilder` component props.
 */
export interface RichExpressionBuilderProps extends RichPluginRequiredProps, Omit<ExpressionBuilderProps, 'expression' | 'types' | 'onChange'> {
    /**
