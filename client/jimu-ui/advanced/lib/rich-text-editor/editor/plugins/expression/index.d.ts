...
import { type PanelHeaderProps, type PopperProps } from 'jimu-ui';
/**
 * The `RichExpressionBuilderPopper` component props.
 */
export interface RichExpressionBuilderPopperProps extends RichExpressionBuilderProps, Omit<PopperProps, 'reference' | 'children' | 'onChange'> {
