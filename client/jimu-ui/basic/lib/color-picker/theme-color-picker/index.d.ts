...
import { type Placement, type PopperProps } from 'jimu-ui';
import { type ColorItem, type PickerBlockProps } from '../components';
/**
 ...
 * ```
 */
export declare const ThemeColorPicker: (props: ThemeColorPickerProps) => React.JSX.Element;
export * from './custom-color/sketch-standard-button';
export * from './theme-color/theme-color-selector';
export * from './theme-color-sketch';
