exports.getCommon = function (commonOptions = {}) {
  ...
  const jsApiUrl = process.env.ARCGIS_JSAPI_URL || 'https://js.arcgis.com/4.31/';
  ...
  function isRequestExternal(request){
    ...
    const fullMatchPackages = [
      ...
      'jimu-ui/advanced/map', 'jimu-ui/advanced/chart', 'jimu-ui/advanced/coordinate-control', 'arcgis-charts-components', 'calcite-components', 'jimu-ui/advanced/chart-engine',

      '@arcgis/analysis-components', '@arcgis/analysis-core', '@arcgis/analysis-shared-utils', '@arcgis/analysis-raster-function-utils', '@arcgis/analysis-tool-app',
