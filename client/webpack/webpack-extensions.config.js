...
let mergedWidgetConfigInfo = webpackExtCommon.mergeThemeWidgetWebpackInfo(widgetsConfigInfo, 'widgets');
let mergedThemeConfigInfo = webpackExtCommon.mergeThemeWidgetWebpackInfo(themesConfigInfo, 'themes');
...
let toBeCleanThemes = allThemeInfo.map(info => {
