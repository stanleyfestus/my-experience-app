import { type DataSourceManager, type IMDataSourceJson, type IMDataSourceSchema, type IMReversedDataSourceSchema, type IMDataSourceInfo, type ImmutableArray, type IMDataViewJson, type ImmutableObject } from 'jimu-core';
import type { GeometryType } from '@esri/arcgis-rest-feature-service';
import { type DataSource, type DataSourceConstructorOptions, type DataRecord, DataSourceStatus, type SelectOptions, type QueryResult, type UsedFieldsOptions, type SetDataSourceMixin } from '../interfaces';
import type { SetDataSourceMixinImpl } from '../mixins/set-data-source-mixin';
/**
...
export declare abstract class AbstractDataSource implements DataSource {
    ...
    isDataSourceSet(): this is DataSource & typeof SetDataSourceMixinImpl;
    get url(): string;
    set url(u: string);
    ...
    private traverseToMergeDataSourceJson;
