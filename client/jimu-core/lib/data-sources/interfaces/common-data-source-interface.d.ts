...
export declare const AllDataSourceTypes: {
    ...
    SubtypeGroupLayer: DataSourceTypes.SubtypeGroupLayer;
    SubtypeSublayer: DataSourceTypes.SubtypeSublayer;
    ...
    VectorTileService: DataSourceTypes.VectorTileService;
    GeoJSON: DataSourceTypes.GeoJSON;
    KML: DataSourceTypes.KML;
    WFS: DataSourceTypes.WFS;
    WMS: DataSourceTypes.WMS;
    WMTS: DataSourceTypes.WMTS;
    BuildingSceneLayer: DataSourceTypes.BuildingSceneLayer;
    BuildingGroupSubLayer: DataSourceTypes.BuildingGroupSubLayer;
    BuildingComponentSubLayer: DataSourceTypes.BuildingComponentSubLayer;
    OrientedImageryLayer: DataSourceTypes.OrientedImageryLayer;
    ImageryLayer: DataSourceTypes.ImageryLayer;
    ImageryTileLayer: DataSourceTypes.ImageryTileLayer;
    ElevationLayer: DataSourceTypes.ElevationLayer;
};
/**
* All data source types, including types from jimu-core and jimu-arcgis.
