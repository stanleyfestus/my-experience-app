import { type SetDataSourceMixin, type DataSourceTypes } from './common-data-source-interface';
import { type ArcGISQueryParams, type ArcGISQueriableDataSource, type FeatureDataRecord } from './arcgis-queriable-data-source-interface';
