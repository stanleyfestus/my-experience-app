import { type ImmutableObject, type IMDataSourceJson } from 'jimu-core';
import { DataSourceTypes, type SubtypeGroupLayerDataSource, type SubtypeSublayerDataSource, type ArcGISSubtypeSublayer, type ArcGISQueryParams, type FeatureDataRecord, type ArcGISSelectOptions } from '../interfaces';
...
export declare class SubtypeSublayerDataSourceImpl extends AbstractArcGISQueriableDataSource implements SubtypeSublayerDataSource {
    ...
    protected jsAPILayerQueryObjectIds(query: __esri.Query | __esri.QueryProperties, layer?: ArcGISSubtypeSublayer | __esri.FeatureLayer): Promise<number[]>;
