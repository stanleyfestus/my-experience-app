...
import { type IMState, type AppContext, type AppRuntimeInfo, type IMJimuMapViewInfo, type SectionNavInfo, type IMDataSourceInfo, type IMMapWidgetInfo, type DialogInfos, type LoadAppConfigError } from './types/state';
import { type Selection, type ClipboardItem, type LayoutInfo } from './types/layout';
import { type AppMode, BrowserSizeMode, type PagePart, type LoadingType, type PortalInfo } from './types/common';
import { type UrlParameters, type UrlHashParameters } from './types/url-parameters';
import { DataSourceStatus, type SelectOptions, type QueryParams } from './data-sources/interfaces';
...
export declare enum ActionKeys {
    ...
    ResetWidgetState = "RESET_WIDGET_STATE",
...
export interface WidgetToolbarClassLoadedAction extends UnknownAction {
    type: ActionKeys.WidgetToolbarClassLoaded;
    widgetId: string;
    toolNames: string[];
    isNew: boolean;
}
export interface WidgetToolbarIsNewFlagChangeAction extends UnknownAction {
    type: ActionKeys.WidgetToolbarIsNewFlagChange;
    widgetId: string;
    toolNames: string[];
    isNew: boolean;
}
...
export interface ResetWidgetStateAction extends UnknownAction {
    type: ActionKeys.ResetWidgetState;
    widgetId: string;
}
...
export interface LayoutChangedAction extends UnknownAction {
...
export declare function widgetToolbarClassLoaded(widgetId: string, toolNames: string[], isNew: boolean): WidgetToolbarClassLoadedAction;
export declare function widgetToolbarIsNewFlagChange(widgetId: string, toolNames: string[], isNew: boolean): WidgetToolbarIsNewFlagChangeAction;
/**
...
export declare function resetWidgetState(widgetId: string): ResetWidgetStateAction;
