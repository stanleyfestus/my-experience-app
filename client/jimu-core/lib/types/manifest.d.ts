...
import { type MessageDescription, type MessageType } from '../message/message-base-types';
import { type Size, type WidgetType } from './common';
import { type ExtensionPoints } from '../extension-spec/extension-spec';
import { type ThemeThemeColors } from './theme';
