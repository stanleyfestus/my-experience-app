...
import { type FeatureDataRecord, type IMArcGISQueryParams, type DataSource, type ItemMixin, type TimeExtent, type ArcGISQueriableDataSource, type IFeatureLayer } from '../../data-sources/interfaces';
...
export declare function enhanceFieldDomainByRecords(jsAPIFields: __esri.FieldProperties[], jsAPIGraphics: __esri.Graphic[]): void;
