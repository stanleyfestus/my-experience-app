export declare class IndexedDBCache {
     ...
     * @param keyPath the keyPath of the store
     * @returns IndexedDBCache
     */
    constructor(widgetId: string, widgetName: string, storeName: string, version?: number, indexName?: string, indexKey?: string, keyPath?: string);
    /**
    ...
    getAll(): Promise<any[]>;
    /**
     * get all values from the store by index
     */
    openCursor(direction: IDBCursorDirection): Promise<IDBCursorWithValue>;
    /**
