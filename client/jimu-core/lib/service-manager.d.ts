import { type ServiceInfo, type ArcGISServerInfo } from './types/common';
...
export default class ServiceManager {
    ...
    clearServiceInfo(url: string): void;
    ...
    /**
     * Only return definitions of child layers (including all descendant layers).
