import { type IMLayoutJson, type IMBoundingBox, type IMState, type IMAppConfig, type IMLayoutItemJson, type BrowserSizeMode, type PagePart, type LayoutItemConstructorProps, type BoundingBox } from 'jimu-core';
