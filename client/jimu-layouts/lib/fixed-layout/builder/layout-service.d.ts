...
export declare class FixedLayoutService extends BaseLayoutService {
    ...
    processAfterItemAdded(appConfig: IMAppConfig, draggingItem: LayoutItemConstructorProps, layoutInfo: LayoutInfo, currentSizeMode: BrowserSizeMode, containerRect: DOMRectReadOnly, itemRect: DOMRectReadOnly, insertIndex: number, options: {
