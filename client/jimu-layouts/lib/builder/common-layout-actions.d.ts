...
export declare function pasteToFlowLayout(clipboardItem: ClipboardItem, targetLayoutId: string): Promise<void>;
/**
...
export declare function sinkingLayoutItem(layoutInfo: LayoutInfo, clientRect: DOMRect): Promise<void>;
/**
 ...
 * @param appConfig
 */
export declare function addBlockToFlowLayout(draggingItem: LayoutItemConstructorProps, targetLayoutId: string, containerRect: DOMRect, itemRect: DOMRect, width: number, insertIndex: number, appConfig?: IMAppConfig): Promise<void>;
