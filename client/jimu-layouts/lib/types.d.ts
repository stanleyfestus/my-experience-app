import { type React, type IMLayoutItemJson, type IMSizeModeLayoutJson, type LayoutItemConstructorProps, type IMLayoutJson, type ImmutableArray, type LayoutInfo, type IMViewJson, type IMWidgetJson, type LayoutContextToolProps, type IMSectionNavInfo, type AnimationSetting, type AnimationPlayMode, type BrowserSizeMode, type WidgetInitDragCallback, type WidgetInitResizeCallback } from 'jimu-core';
