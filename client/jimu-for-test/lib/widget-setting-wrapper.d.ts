...
import { type RawWidgetSettingType, type WidgetSettingInjectedProps, type AllWidgetSettingProps } from 'jimu-for-builder';
...
export type WrappedWidgetSettingProps = Partial<Omit<WidgetSettingInjectedProps<unknown>, 'theme' | 'intl'>>;
/**
