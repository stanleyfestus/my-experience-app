import { type IMAppConfig, type LayoutInfo, type IMLayoutJson, BrowserSizeMode, type IMSizeModeLayoutJson, type SizeModeLayoutJson, type LayoutItemConstructorProps, type IconResult, type ImmutableObject, LayoutType, LayoutItemType, LayoutParentType } from 'jimu-core';
...
export declare abstract class BaseLayoutService {
    ...
    abstract processAfterItemAdded(appConfig: IMAppConfig, draggingItem: LayoutItemConstructorProps, layoutInfo: LayoutInfo, currentSizeMode: BrowserSizeMode, containerRect: DOMRectReadOnly, itemRect: DOMRectReadOnly, insertIndex: number, options?: any): IMAppConfig;
