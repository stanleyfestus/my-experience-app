import { type IMAppConfig, type WidgetJson, type IMWidgetJson, type LayoutInfo, BrowserSizeMode } from 'jimu-core';
import { BaseContentService, type DuplicateContext } from './base-content-service';
...
export declare class WidgetService extends BaseContentService {
    ...
    duplicateEmbedLayout(appConfig: IMAppConfig, contentId: string, fromSizeMode: BrowserSizeMode, toSizeMode: BrowserSizeMode): [appConfig: IMAppConfig, newContentId: string];
