import { type IMAppConfig, type ImmutableArray, type LayoutInfo, type BrowserSizeMode } from 'jimu-core';
...
export declare abstract class BaseContentService {
    ...
    abstract duplicateEmbedLayout(appConfig: IMAppConfig, contentId: string, fromSizeMode: BrowserSizeMode, toSizeMode: BrowserSizeMode): [appConfig: IMAppConfig, newContentId: string];
    /**
