import { type IMAppConfig, type IMLayoutItemJson, type LayoutInfo, type BrowserSizeMode, type LayoutItemJson } from 'jimu-core';
import { type BaseContentService, type DuplicateContext } from './base-content-service';
...
export declare class ContentServiceWrapper {
    ...
    duplicateEmbedLayout(fromSizeMode: BrowserSizeMode, toSizeMdoe: BrowserSizeMode): [appConfig: IMAppConfig, newContentId: string];
