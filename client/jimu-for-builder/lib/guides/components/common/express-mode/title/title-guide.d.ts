...
export declare const _TitleGuide: (props: GuideProps & StateToProps) => React.JSX.Element;
export declare const ExpressTitleGuide: ReactRedux.ConnectedComponent<(props: GuideProps & StateToProps) => React.JSX.Element, {
    disabled?: boolean;
    className?: string;
    params?: any;
    steps: Steps;
