...
export declare const _ThemeGuide: (props: GuideProps) => React.JSX.Element;
export declare const ExpressThemeGuide: ReactRedux.ConnectedComponent<(props: GuideProps) => React.JSX.Element, {
    disabled?: boolean;
    className?: string;
    params?: any;
    steps: Steps;
