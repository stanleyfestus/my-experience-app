...
export declare const _PlaceHolderGuide: (props: GuideProps) => React.JSX.Element;
export declare const ExpressPlaceHolderGuide: ReactRedux.ConnectedComponent<(props: GuideProps) => React.JSX.Element, {
    disabled?: boolean;
    className?: string;
    params?: any;
    steps: Steps;
