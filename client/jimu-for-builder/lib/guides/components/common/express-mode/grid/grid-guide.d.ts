...
export declare const _GridGuide: (props: GuideProps & StateToProps) => React.JSX.Element;
export declare const ExpressGridGuide: ReactRedux.ConnectedComponent<(props: GuideProps & StateToProps) => React.JSX.Element, {
    disabled?: boolean;
    className?: string;
    params?: any;
    steps: Steps;
