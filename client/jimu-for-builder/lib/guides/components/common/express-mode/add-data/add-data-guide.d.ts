...
export declare const _AddDataGuide: (props: GuideProps) => React.JSX.Element;
export declare const ExpressAddDataGuide: ReactRedux.ConnectedComponent<(props: GuideProps) => React.JSX.Element, {
    disabled?: boolean;
    className?: string;
    params?: any;
    steps: Steps;
