...
export declare const _GeneralSettingGuide: (props: GuideProps) => React.JSX.Element;
export declare const ExpressGeneralSettingGuide: ReactRedux.ConnectedComponent<(props: GuideProps) => React.JSX.Element, {
    disabled?: boolean;
    className?: string;
    params?: any;
    steps: Steps;
