...
export declare const _AppSettingGuide: (props: GuideProps) => React.JSX.Element;
export declare const ExpressAppSettingGuide: ReactRedux.ConnectedComponent<(props: GuideProps) => React.JSX.Element, {
    disabled?: boolean;
    className?: string;
    params?: any;
    steps: Steps;
