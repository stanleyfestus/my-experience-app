...
export declare const _WindowGuide: (props: GuideProps) => React.JSX.Element;
export declare const ExpressWindowGuide: ReactRedux.ConnectedComponent<(props: GuideProps) => React.JSX.Element, {
    disabled?: boolean;
    className?: string;
    params?: any;
    steps: Steps;
