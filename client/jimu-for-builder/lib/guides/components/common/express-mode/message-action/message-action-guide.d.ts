...
export declare const _MessageActionGuide: (props: GuideProps) => React.JSX.Element;
export declare const ExpressMessageActionGuide: ReactRedux.ConnectedComponent<(props: GuideProps) => React.JSX.Element, {
    disabled?: boolean;
    className?: string;
    params?: any;
    steps: Steps;
