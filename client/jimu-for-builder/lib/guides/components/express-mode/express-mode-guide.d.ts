...
export declare const _ExpressModeGuide: (props: GuideProps) => React.JSX.Element;
export declare const ExpressModeGuide: ReactRedux.ConnectedComponent<(props: GuideProps) => React.JSX.Element, {
    disabled?: boolean;
    className?: string;
    params?: any;
    steps: Steps;
