import { Immutable, type ImmutableObject, type ImmutableArray, type WidgetsJson, type AppConfig, UrlGeneralConfig, type UrlParamsWidgetsConfig, type BrowserSizeMode } from 'jimu-core';
